            ...
            {learningTracks.map((track) => (
              ...
              >
                ...
                <div className="relative flex flex-1 flex-col">
                  ...
                  {/* CTAs */}
                  <div className="mt-8 flex flex-wrap items-center gap-x-5 gap-y-2 md:mt-auto md:pt-8">
                    <Link
                      href={track.href}
                      className="inline-flex items-center text-sm font-semibold text-orange-600 transition-colors hover:text-orange-500 dark:text-orange-300 dark:hover:text-orange-200"
                    >
                      {track.cta}
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <Link
                      href="/courses/register"
                      className="inline-flex items-center text-sm font-semibold text-slate-600 transition-colors hover:text-orange-600 dark:text-slate-300 dark:hover:text-orange-300"
                    >
                      Đăng ký tư vấn
                    </Link>
                  </div>
