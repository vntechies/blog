...
![Hãy đóng góp cho VNTechies Dev Blog bạn nhé](/static/images/contribute.png)

_Contributors của [VNTechies Dev Blog](https://dev.vntechies.com/) ở một góc phố nhỏ_
...
- Với các ý tưởng mới về bài viết, xin vui lòng thảo luận qua messenger hoặc email trước.
