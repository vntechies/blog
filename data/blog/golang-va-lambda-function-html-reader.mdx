---
title: 'Golang và Lambda function: HTML Reader'
date: '2022-08-18'
tags: ['aws', 'lambda', 'go', 'htmlreader', 'tutorial', 'aws sam', 'serverless']
draft: false
...
func handler(request events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
	...
	html := "<!DOCTYPE html><html><head><meta charset='utf-8'/><title>GO READER</title><meta name='viewport' content='width=device-width, initial-scale=1'/><link rel='stylesheet' href='https://unpkg.com/bamboo.css'/></head><body><h2 id='title'>" + article.Title + "</h2><p id='output'>" + article.Content + "</p></body></html>"
...
Lambda xứng đáng là một chọn lựa tiềm năng cho các stack công nghệ phát triển với Golang.
