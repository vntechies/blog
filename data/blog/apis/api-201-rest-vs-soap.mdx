...
date: '2020-11-11'
tags: ['api', 'soap', 'rest api', 'apis series']
draft: false
...
Tiếp tục [bài viết trước](/rest-101-rest-restful-api), liệu `REST` có vượt trội so với `SOAP` theo như ý kiến của tác giả dưới đây?
...
![](./29472802_10213888263114999_1471996776805302272_o.jpg)

1. `REST`

   - `REST` thích ứng tốt với các công nghệ web mới, dễ dàng sử dụng và bảo trì.
   - Tách biệt rõ ràng giữa server và client, chỉ giao tiếp thông qua các phương thức `HTTP` và `URI` (đọc lại bài viết [REST 101](/rest-101-rest-restful-api)).
...
![](./29472578_10213888610963695_2986071309554810880_n.jpg)
...
![](./29473101_10213888611443707_4940117047951491072_n.jpg)
