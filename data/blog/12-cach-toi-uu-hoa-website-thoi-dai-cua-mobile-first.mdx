...
![Phân tích tốc độ của các DNS provider](./jAOAsuDFTd9l0zPK.jpg)
...
![Phân tích tốc độ của các CDN provider](./luVNJqudPakH-jpc.jpg)
...
_[dev.vntechies.com](https://dev.vntechies.com/)_ được host trên Amplify, sử dụng CloudFront CDN 😅
