---
title: '90 Ngày DevOps - Vòng đời DevOps - Tập trung vào ứng dụng - Ngày 3'
draft: false
layout: PostSimple
images: ['/static/images/ogps/90daysofdevopsd3.png']
summary: 'Ngày 3 - Vòng đời DevOps - Tập trung vào ứng dụng. Các quá trình trong phát triển phần mềm và vòng đời DevOps: Phát triển, Kiểm thử, Tích hợp, Triển khai và Giám sát'
tags: ['devops', '90daysofdevops']
series: ['90-ngay-devops']
date: '2022-09-17'
---

![90 Ngày DevOps - Vòng đời DevOps - Tập trung vào ứng dụng - Ngày 3](/static/images/ogps/90daysofdevopsd3.png)

<TOCInline toc={props.toc} asDisclosure />

## Vòng đời DevOps - Tập trung vào ứng dụng

![Vòng đời DevOps - Tập trung vào ứng dụng](/static/images/assets/devopslifecycle.png)
...
![Chúng ta thường sử dụng các containers để mô phỏng môi trường kiểm thử](/static/images/assets/devopscontainers.png)
...
![Việc sử dụng vị trí "kỹ sư DevOps" ở trên chỉ để làm nổi bật phạm vi mà quy trình được sử dụng bởi bất kỳ vị trí nào ở trên và các vị trí khác](/static/images/assets/devopstesting.jpeg)
...
Nếu bạn đã đi được tới đây, bạn chắn hẳn đã biết rõ liệu đây có phải là hành trình bạn muốn theo đuổi hay không. Hẹn gặp lại vào [ngày 4](/blog/90-ngay-devops/ngay-4).
