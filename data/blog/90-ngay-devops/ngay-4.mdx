---
title: '90 Ngày DevOps - DevOps & Agile - Ngày 4'
draft: false
layout: PostSimple
images: ['/static/images/ogps/90daysofdevopsd4.png']
summary: 'Ngày 4 - DevOps & Agile. Trong bài viết này, chúng ta sẽ xem xét sự khác biệt quan trọng giữa Agile và DevOps và tìm hiểu lý do tại sao hai thứ được kết nối chặt chẽ như vậy.'
tags: ['devops', '90daysofdevops']
series: ['90-ngay-devops']
date: '2022-09-20'
---

![90 Ngày DevOps - DevOps & Agile - Ngày 4](/static/images/ogps/90daysofdevopsd4.png)
...
![Trong bài viết này, chúng ta sẽ xem xét sự khác biệt quan trọng giữa Agile và DevOps và tìm hiểu lý do tại sao hai thứ được kết nối chặt chẽ như vậy.](/static/images/assets/DevOps-vs-Agile.webp)

_[©hava.io](https://www.hava.io/blog/devops-vs-agile)_
...
![Sự khác biệt giữa Agile và DevOps](/static/images/assets/agilevsdevops.jpeg)
...
![Kết hợp với nhau... có phải là một ý tưởng tốt? cần thảo luận?](/static/images/assets/agiledevopscooperate.png)

_[©Agile First](https://agilefirst.io/agile-devops/)_
...
Nếu bạn đã đi được tới đây, bạn chắn hẳn đã biết rõ liệu đây có phải là hành trình bạn muốn theo đuổi hay không. Hẹn gặp lại vào [ngày 5](/blog/90-ngay-devops/ngay-5).

## License

[![CC BY-NC-SA 4.0][cc-by-nc-sa-image]][cc-by-nc-sa]

Bài viết là bản tiếng Việt của tài liệu [90DaysOfDevOps](https://github.com/MichaelCade/90DaysOfDevOps/tree/main/Days) của [Micheal Cade](https://twitter.com/MichaelCade1) và có license [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License][cc-by-nc-sa].
