---
title: '90 Ngày DevOps - Trách nhiệm của kỹ sư DevOps - Ngày 2'
draft: false
layout: PostSimple
images: ['/static/images/ogps/90daysofdevopsd2.png']
summary: Ngày 2 - Trách nhiệm của kỹ sư DevOps và tổng quan về những kiến thức/kỹ năng cần có để trở thành một kỹ sư DevOps tốt
tags: ['devops', '90daysofdevops']
series: ['90-ngay-devops']
date: '2022-09-15'
---

![90 Ngày DevOps - Trách nhiệm của kỹ sư DevOps - Ngày 2](/static/images/ogps/90daysofdevopsd2.png)

<TOCInline toc={props.toc} asDisclosure />

## Trách nhiệm của kỹ sư DevOps

Hy vọng bạn tới với bài viết này sau khi đọc xong [ngày 1](/blog/90-ngay-devops/ngay-1) của [#90ngàydevops](/tags/90daysofdevops)
...
![Trách nhiệm của kỹ sư DevOps](/static/images/assets/devops-meme1.png)
...
![Làm DevOps cũng nhàn](/static/images/assets/devopscungnhan.png)
...
![Automation rất quan trọng với kỹ sư DevOps](/static/images/assets/devops-meme2.png)
...
Nếu bạn đã đi được tới đây, bạn chắn hẳn đã biết rõ liệu đây có phải là hành trình bạn muốn theo đuổi hay không. Hẹn gặp lại vào [ngày 3](/blog/90-ngay-devops/ngay-3).
