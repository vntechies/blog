---
title: Triển khai ứng dụng springboot trên Kubernetes - giới thiệu
date: '2020-11-11'
tags: ['api', 'rest api']
...
| Project             | Value                   | Dependencies                     |
| ------------------- | ----------------------- | -------------------------------- |
| Tên                 | `k8s-springboot-series` | `Spring Web`                     |
| Build tool          | `Maven`                 | `Spring Boot DevTools`           |
| Spring Boot version | `2.7.6`                 | `Lombok`                         |
| Java version        | `11`                    | `Spring Configuration Processor` |
