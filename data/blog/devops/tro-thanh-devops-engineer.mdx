---
title: 'Làm thế nào để trở thành một kỹ sư DevOps? Hướng dẫn đầy đủ'
date: '2022-10-25'
tags:
  [
    'devops',
...
Trong hướng dẫn đầy đủ này, tôi sẽ chia sẻ những kinh nghiệm với vai trò Kỹ sư DevOps của mình trong các tổ chức khác nhau và những kiến thức nền tảng cần học, chuẩn bị để trở thành một kỹ sư DevOps. Đây là một lộ trình chi tiết để bắt đầu hành trình trở thành một kỹ sư DevOps của bạn.
...
Nhiều người (bao gồm cả tôi) cho rằng không có gì title nào là "Kỹ sư DevOps” hoặc "Nhóm DevOps” bởi vì nó không có thật. Tuy nhiên, mọi người trong ngành hiện đã quen với thuật ngữ "Kỹ sư DevOps” và miễn là bạn hiểu triết lý, văn hoá DevOps, thì những danh xưng này không quan trọng lắm.
...
4. [Học Linux trong 5 ngày](https://www.udemy.com/course/learn-linux-in-5-days/) [Udemy]
5. [Hướng dẫn Vagrant cho người mới bắt đầu](https://devopscube.com/vagrant-tutorial-beginners/) [devopscube]

<a
  target="new"
  href="https://click.linksynergy.com/fs-bin/click?id=s52ad97YwsI&offerid=1074652.81&type=3&subid=0"
>
  Invest in your future. Udemy online courses up to 85% off during our Cyber Sale.
</a>
<img
  border="0"
  width="1"
  alt=""
  height="1"
  src="https://ad.linksynergy.com/fs-bin/show?id=s52ad97YwsI&bids=1074652.81&type=3&subid=0"
/>
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| 1. SSL certificates<br />2. PKI Infrastructure<br />3. Zero trust security<br />4. Password/secret rotation<br />5. Security Compliance<br />6. Site-to-site VPN<br />7. Client-to-site VPN | 1. L4 Load Balancers<br />2. L7 Load Balancers<br />3. Load balancing algorithms<br />4. Reverse Proxy |
...
1. [Udemy AWS Certification Courses](https://www.udemy.com/topic/aws-certification/)
2. [Google Certified Associate Cloud Engineer Certification](https://cloud.google.com/certification/cloud-engineer)
3. [Microsoft Azure - Beginner's Guide + AZ-900 preparation](https://www.udemy.com/course/microsoft-azure-beginners-guide/)

### Chứng chỉ liên quan

1. [Kinh nghiệm thi chứng chỉ AWS Certified Solutions Architect - Professional SAP-C01 (2022)](/blog/aws-certs/kinh-nghiem-thi-chung-chi-aws-certified-solutions-architect-professional-sap-c01)
2. [Kinh nghiệm thi chứng chỉ AWS Certified Solutions Architect - Associate SAA-C03 (2022)](/blog/aws-certs/kinh-nghiem-thi-chung-chi-aws-certified-solutions-architect-associate-saa-c03)
...
| --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| 1. Vagrant<br />2. Docker Desktop<br />3. Minikube (k8s)<br />4. Minishift (k8s)<br />5. Kind (k8s) | 1. Terraform, Terraform CDK (preferable)<br />2. Cloudformation for AWS, AWS CDK<br />3. CLIs (of respective cloud provider)<br />4. Pulumi |

| **For Configuration Management**                                      | **VM image management** |
| --------------------------------------------------------------------- | ----------------------- |
| 1. Ansible (preferable)<br />2. Chef<br />3. Puppet<br />4. Saltstack | 1. Hashicorp Packer     |
...
1. [Learn DevOps: Infrastructure Automation With Terraform](https://www.udemy.com/course/learn-devops-infrastructure-automation-with-terraform)
2. [Ansible for the Absolute Beginner - Hands-On - DevOps](https://www.udemy.com/course/learn-ansible/)
...
## Container, Hệ thống phân tán & Service Mesh

Việc sử dụng container đang tăng lên từng ngày. Tổ chức bạn làm việc có thể hiện không sử dụng container. Tuy nhiên, tốt nhất là bạn nên có kiến thức thực hành về công nghệ container như Docker hoặc podman. Nó sẽ giúp bạn có được một số lợi thế cạnh tranh với các đồng nghiệp của mình.
...
Ngoài ra, nhiều kỹ sư và thậm chí cả những sinh viên mới tốt nghiệp đại học đang quan tâm đến việc học Kubernetes. Năm 2022 sẽ chứng kiến nhiều kỹ sư được cấp chứng chỉ Kubernetes. Bạn có thể xem hướng dẫn về kỳ thi CKA, CKAD và CKS của chúng tôi. Bạn có thể chọn chứng nhận Kubernetes tốt nhất dựa trên domain bạn muốn làm việc.
...
Log và giám sát là những khía cạnh cơ bản của cơ sở hạ tầng.
...
1. [Elasticsearch 8 and the Elastic Stack: In Depth and Hands On](https://www.udemy.com/course/elasticsearch-7-and-elastic-stack)
2. [Monitoring and Alerting with Prometheus](https://www.udemy.com/course/monitoring-and-alerting-with-prometheus)
...
1. [HashiCorp Vault: The Advanced Course](https://www.udemy.com/course/vaultadvanced)
...
Đề xuất của tôi là **chọn một ngôn ngữ lập trình và xây dựng một ứng dụng từ đầu**. Khi tôi bắt đầu sự nghiệp của mình, tôi đã xây dựng một ứng dụng web từ đầu bằng Ruby on Rails mặc dù phát triển ứng dụng không phải là công việc chính của tôi. Cho đến hôm nay, nó đã giúp tôi hiểu nhiều khái niệm của các kỹ sư phát triển.
...
Ngoài ra, trong thế giới ngày nay, mọi thứ đề được coi như mã nguồn. Dù có đủ các công cụ để tự động hóa mọi thứ, bạn vẫn có thể cần tuỳ chỉnh một chức năng mà công cụ không cung cấp. Trong những trường hợp như vậy, việc có kỹ năng code/scripting là rất hữu ích.
...
2. [2022 Complete Python Bootcamp From Zero to Hero in Python](https://www.udemy.com/course/complete-python-bootcamp)
3. [Learn How To Code: Google's Go (golang) Programming Language](https://www.udemy.com/course/learn-how-to-code)
4. [Linux Shell Scripting: A Project-Based Approach to Learning](https://www.udemy.com/course/linux-shell-scripting-projects)
...
- [DevOpsCube - Become A DevOps Engineer in 2022: A Comprehensive Guide](https://devopscube.com/become-devops-engineer/)
  > Bài viết là bản dịch tiếng Việt của blog trên đã được sửa đổi, bổ sung
