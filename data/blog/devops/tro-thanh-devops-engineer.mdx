...
1. [**MIỄN PHÍ** - Coursera] [DevOps Culture and Mindset](https://www.coursera.org/learn/devops-culture-and-mindset)
2. [**CÓ PHÍ** - Sách điện tử] [The Phoenix Project](https://amzn.to/3F0gGm7)
...
1. [Giới thiệu về Linux](https://www.edx.org/course/introduction-to-linux) [edX]
2. [Học shell scripting cho DevOps](https://devopscube.com/linux-shell-scripting-for-devops/) [devopscube]
