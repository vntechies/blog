...
authors: ['hai nguyen', 'ha nguyen']
images: ['/static/images/assets/eks.png']
summary: 'This blog shows how to mitigate disruption during EKS cluster upgrade with blue/green deployment'
---

## Table of Contents

- [In-place and blue/green upgrade strategies](#inplaceandbluegreen)
- [Upgrade cluster process](#upgrade)
  - [Prerequisite](#prerequisite)
  - [Update manifests](#updatemanifest)
  - [Bootstrap new cluster](bootstrap)
  - [Re-deploy add-ons and third-party tools with compatible version](#redeployaddson)
  - [Re-deploy workloads](#redeployworkload)
  - [Verify workloads](#verifyworkload)
  - [DNS switchover](#dnsswitchover)
- [Stateful workloads migration](#statefulworkload)
...
## In-Place vs. Blue/Green upgrade strategies\*\* <a name="inplaceandbluegreen"></a>
...
## Upgrade cluster process <a name="upgrade"></a>

### 1. Prerequisite <a name="prerequisite"></a>
...
### 2. Update manifests <a name="updatemanifest"></a>
...
### 3. Bootstrap new cluster <a name="bootstrap"></a>
...
### 4. Re-deploy add-ons and third-party tools with compatible version <a name="redeployaddson"></a>
...
### 5. Re-deploy workloads <a name="redeployworkload"></a>
...
### 6. Verify workloads <a name="verifyworkload"></a>
...
### 7. DNS Switchover <a name="dnsswitchover"></a>
...
## Stateful workloads migration <a name="statefulworkload"></a>
