...
date: '2022-08-23'
tags: ['aws', 'aws cdk', 'tutorial', 'python']
draft: false
...
![AWS Cloud Development Kit](/static/images/ogps/awssdk.png)
...
Vì chúng ta sử dụng AWS CDK với sample-app nên các tài nguyên này đã được tạo trước.
...
Để deploy ứng dụng sau khi được tổng hợp bởi câu lệnh `cdk synth`, bạn cần [cài đặt AWS CLI](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html)
và [AWS profile](https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-profiles.html) trên máy của bạn
