...
date: '2022-08-25'
tags: ['aws', 'aws cdk', 'tutorial', 'python', 'aws-cdk-series', 'devops']
draft: false
...
Để deploy ứng dụng sau khi được tổng hợp bởi câu lệnh `cdk synth`, bạn cần [cài đặt AWS CLI và AWS profile](/blog/aws/cdk/tao-s3-bucket-voi-aws-cdk#2-cài-đặt-aws-cli-và-cài-đặt-aws-profile) trên máy của bạn.
