...
date: '2022-08-29'
tags: ['aws', 'aws cdk', 'dynamodb', 'lambda', 'apigw', 'tutorial', 'aws-cdk-series', 'devops']
draft: false
...
![](/static/images/ogps/cuturl.png)

Trong bài viết dưới đây, chúng ta sẽ xây dựng một ứng dụng rút gọn link (url shortener) sử dụng AWS CDK với Api Gateway, Lambda Function và DynamoDB.
Nếu các bạn chưa có nhiều kinh nghiệm làm việc với AWS CDK, VNTechies khuyến nghị các bạn tham khảo 2 bài viết dưới đây trong [loạt bài về AWS CDK](http://localhost:3000/tags/aws-cdk-series).
...
1. AWS CDK (có thể tham khảo [Hướng dẫn chi tiết cài đặt AWS CDK](/blog/aws/cdk/huong-dan-chi-tiet-cai-dat-aws-cdk))
2. Cài đặt AWS CLI và cài đặt AWS profile (có thể tham khảo [hướng dẫn tại đây](/blog/aws/cdk/tao-s3-bucket-voi-aws-cdk#2-cài-đặt-aws-cli-và-cài-đặt-aws-profile))
...
![Demo URL shortener](/static/images/assets/demo_url_shortener.gif)
...
Hãy tham khảo [series về AWS CDK](/tags/aws-cdk-series) và bắt đầu sử dụng ngay từ bây giờ bạn nhé 😉
