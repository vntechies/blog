...
date: '2022-07-01'
tags: ['dev tips', 'cloud computing', 'aws']
draft: true
authors: ['mau']
summary: 'Trình bày về quy ước đặt tên, gắn tag tài nguyên trên AWS theo các best practices để thuận tiện cho việc quản lý, vận hành.'
---
...
Bài viết này sẽ hướng dẫn các bạn host 1 website sử dụng [Raspberry Pi 4](https://www.raspberrypi.org/). Sau đó public website được serve bằng nginx lên Internet.

Dù website của bạn sẽ khó có khả năng scale như khi được host trên Cloud, nhưng ít nhất bạn cũng không lo việc website của bạn bị down khi trời quá nóng 🐧
