---
title: 'Ngày 56 - Bức tranh toàn cảnh: Cơ sở hạ tầng dưới dạng mã (IaC)'
images: ['/static/images/ogps/90daysofdevopsd56.png']
summary: 'Giới thiệu về cơ sở hạ tầng dưới dạng mà - Infrastucture as Code - IaC và tác dụng của nó với DevOps'
...
Hẹn gặp lại các bạn ở [ngày 57](https://vntechies.dev/courses/90-ngay-devops/ngay-57-gioi-thieu-ve-terraform).
