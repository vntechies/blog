---
title: 'Ngày 14 - Bức tranh lớn: DevOps và Linux'
images: ['/static/images/ogps/90daysofdevopsd14.png']
summary: 'Bài viết trình bài về sự liên quan giữa Linux và DevOps và ứng dụng của nó trong các hệ thống thông tin.'
...
![](/static/images/assets/Day14_Linux1.png)
...
Tôi cũng đã đặt một bản sao của tệp vagrant cụ thể này trong [thư mục Linux](https://github.com/vntechies/90DaysOfDevOps/blob/main/2022/Days/Linux/VAGRANTFILE)
...
![](/static/images/assets/Day14_Linux2.png)
...
![](/static/images/assets/Day14_Linux3.png)
...
![](/static/images/assets/Day14_Linux4.png)
...
Hẹn gặp lại các bạn vào [Ngày 15](https://vntechies.dev/courses/90-ngay-devops/ngay-15-cac-lenh-linux-cho-devops).
