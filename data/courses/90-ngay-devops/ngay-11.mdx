...
Vào [ngày 8](/courses/90-ngay-devops/ngay-8), chúng ta thiết lập môi trường, vào [ngày 9](/courses/90-ngay-devops/ngay-9), chúng ta đã xem qua mã Hello #90DaysOfDevOps và vào [ngày 10](/courses/90-ngay-devops/ngay-10)), chúng ta đã tìm hiểu về không gian làm việc Go và đi sâu hơn một chút vào biên dịch và chạy mã.
...
Đây sẽ không phải là phần cuối của chương trình, chúng ta sẽ quay lại vào [ngày 12](/courses/90-ngay-devops/ngay-12) để thêm các chức năng khác. Bây giờ ta sẽ thêm một biến khác cho số ngày đã hoàn thành trong thử thách.
...
Hẹn gặp lại tại [ngày 12](/courses/90-ngay-devops/ngay-12).
