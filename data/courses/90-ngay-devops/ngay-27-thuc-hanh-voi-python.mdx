...
Trong phần cuối của loạt bài về mạng máy tính, chúng ta sẽ tìm hiểu một số tác vụ và công cụ tự động hóa dựa trên môi trường lab đã được tạo ra trong [Ngày 26](/courses/90-ngay-devops/ngay-26-xay-dung-lab).

Chúng ta sẽ sử dụng SSH để kết nối đến các thiết bị trong mạng. Giao tiếp dựa trên SSH sẽ được mã hóa như đã giới thiệu trước đây trong loạt bài về hệ điều hành Linux. Xem lại [ngày 18](/courses/90-ngay-devops/ngay-18-ssh-va-may-chu-web-lamp-stack).
...
Hẹn gặp lại các bạn vào [Ngày 28](/courses/90-ngay-devops/ngay-28-buc-tranh-toan-canh-devops-va-cloud), nơi mà chúng ta sẽ tìm hiểu về điện toán đám mây (cloud computing) và các kiến thức cơ bản xoay quanh chủ đề này.
