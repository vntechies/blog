---
title: 'Ngày 50 - Chọn nền tảng chạy Kubernetes'
images: ['/static/images/ogps/90daysofdevopsd50.png']
summary: 'Các lựa chọn nền tảng để chạy Kubernetes cluster'
...
Hẹn gặp lại vào [ngày 51](https://vntechies.dev/courses/90-ngay-devops/ngay-51-trien-khai-Kubernetes-cluster-dau-tien).
