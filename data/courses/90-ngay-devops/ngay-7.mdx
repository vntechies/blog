...
summary: 'DevOps và việc học một ngôn ngữ lập trình. Tại sao cần phải học lập trình để trở thành kỹ sư DevOps và ngôn ngữ nào, học ra sao để có thể thành công.'
...
Trong 6 ngày tiếp theo của chủ đề này, tôi dự định sẽ viết lại các ghi chú của tôi cho mỗi ngày với mỗi tài liệu ở trên. Bạn sẽ nhận thấy rằng thường mất khoảng 3 giờ cho mỗi ngày. Nếu bạn có thời gian, hãy tiếp tục và học nếu thời gian cho phép.

Hẹn gặp lại các bạn vào ngày 8!
