...
Các thiết bị chuyển mạch (switch) mà chúng ta đã đề cập trong ngày 21 hoạt động ở lớp này [ngày 21](/courses/90-ngay-devops/ngay-21-buc-tranh-toan-canh-devops-va-mang-may-tinh)

![](/static/images/assets/Day22_Networking3.png)

### Lớp mạng (Network)

Bạn có thể đã nghe đến thuật ngữ thiết bị chuyển mạch (switch) lớp 3 hoặc thiết bị chuyển mạch (switch) lớp 2. Trong mô hình OSI, Lớp mạng có nhiệm vụ phân phối dữ liệu từ điểm đầu đến điểm cuối. Đây là nơi chúng ta thấy các địa chỉ IP của các thiết bị như chúng ta đã đề cập trong [ngày 21](/courses/90-ngay-devops/ngay-21-buc-tranh-toan-canh-devops-va-mang-may-tinh).
...
Hẹn gặp lại các bạn vào [Ngày 23](/courses/90-ngay-devops/ngay-23-giao-thuc-mang)
