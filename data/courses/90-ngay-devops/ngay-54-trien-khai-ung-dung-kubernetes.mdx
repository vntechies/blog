---
title: 'Ngày 54 - Triển khai ứng dụng Kubernetes'
images: ['/static/images/ogps/90daysofdevopsd54.png']
summary: 'Chúng ta sẽ lấy các container images của mình và triển khai dưới dạng các pods trên Kubernetes cluster và sử dụng Kubernetes như một bộ điều phối containers'
...
![](/static/images/assets/Day54_Kubernetes1.png)
...
![](/static/images/assets/Day54_Kubernetes2.png)
...
![](/static/images/assets/Day54_Kubernetes3.png)
...
![](/static/images/assets/Day54_Kubernetes5.png)
...
![](/static/images/assets/Day54_Kubernetes8.png)
...
Chúng ta có thể chỉnh sửa tệp của mình sử dụng lệnh sau đẻ mở trình soạn thảo văn bản trong terminal của bạn và cho phép bạn chỉnh sửa deployment của mình.

```shell
kubectl edit deployment nginx-deployment -n nginx
```

![](/static/images/assets/Day54_Kubernetes9.png)
...
![](/static/images/assets/Day54_Kubernetes10.png)

Bạn cũng có thể thay đổi số lượng replicas sử dụng kubectl với câu lệnh

```shell
kubectl scale deployment nginx-deployment --replicas=10 -n nginx
```

![](/static/images/assets/Day54_Kubernetes11.png)
...
![](/static/images/assets/Day54_Kubernetes12.png)
...
![](/static/images/assets/Day54_Kubernetes13.png)
...
![](/static/images/assets/Day54_Kubernetes14.png)
...
Tiếp theo, chúng ta sẽ tạo một service mới sử dụng lệnh

```shell
kubectl expose deployment nginx-deployment --name nginx-service --namespace nginx --port=80 --type=NodePort
```

lưu ý ở đây rằng chúng ta sẽ sử dụng Expose và thay đổi type thành NodePort.

![](/static/images/assets/Day54_Kubernetes15.png)

Cuối cùng trong terminal mới chạy lệnh dưới đây để tạo một tunnel cho service của chúng ta.

```shell
minikube --profile='mc-demo' service nginx-service --URL -n nginx
```

![](/static/images/assets/Day54_Kubernetes16.png)

Mở trình duyệt và click vài liên kết trong terminal.

![](/static/images/assets/Day54_Kubernetes17.png)
...
Hẹn gặp lại vào [ngày 55](https://vntechies.dev/courses/90-ngay-devops/ngay-55-state-va-ingress-trong-kubernetes).
