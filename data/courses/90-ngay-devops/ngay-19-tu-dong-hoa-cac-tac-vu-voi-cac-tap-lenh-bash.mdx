...
Trước hết, chúng ta sẽ cần một trình soạn thảo văn bản. Vào [ngày 17](/courses/90-ngay-devops/ngay-17-text-ediors-nano-vs-vim), chúng ta đã đề cập đến hai trình soạn thảo văn bản phổ biến nhất và một chút về cách sử dụng chúng.
...
Tất cả các lệnh đã được sử dụng trước đó trong bài về Linux [Ngày 15](/courses/90-ngay-devops/ngay-15-cac-lenh-linux-cho-devops) có thể được sử dụng ở đây như một lệnh đơn giản để kiểm tra tập lệnh của chúng ta.
...
Hẹn gặp lại vào [ngày 20](/courses/90-ngay-devops/ngay-20-thiet-lap-may-tram-phat-trien).
