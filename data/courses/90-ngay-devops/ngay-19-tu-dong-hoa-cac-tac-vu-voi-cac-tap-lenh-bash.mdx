---
title: 'Ngày 19 - Tự động hóa các tác vụ với các tập lệnh bash'
images: ['/static/images/ogps/90daysofdevopsd19.png']
summary: 'Hướng dẫn cơ bản để tự động hoá các công việc lặp đi lặp lại hàng ngày bằng tập lệnh bash.'
...
Trước hết, chúng ta sẽ cần một trình soạn thảo văn bản. Vào [ngày 17](https://vntechies.dev/courses/90-ngay-devops/ngay-17-text-ediors-nano-vs-vim), chúng ta đã đề cập đến hai trình soạn thảo văn bản phổ biến nhất và một chút về cách sử dụng chúng.
...
![](/static/images/assets/Day19_Linux1.png)

Tất cả các lệnh đã được sử dụng trước đó trong bài về Linux [Ngày 15](https://vntechies.dev/courses/90-ngay-devops/ngay-15-cac-lenh-linux-cho-devops) có thể được sử dụng ở đây như một lệnh đơn giản để kiểm tra tập lệnh của chúng ta.
...
![](/static/images/assets/Day19_Linux2.png)
...
![](/static/images/assets/Day19_Linux3.png)
...
![](/static/images/assets/Day19_Linux4.png)
...
![](/static/images/assets/Day19_Linux7.png)
...
![](/static/images/assets/Day19_Linux8.png)
...
![](/static/images/assets/Day19_Linux11.png)
...
![](/static/images/assets/Day19_Linux12.png)
...
![](/static/images/assets/Day19_Linux16.png)

Nếu bạn muốn xóa người dùng mà bạn đã tạo cho mục đích thử nghiệm, bạn có thể làm điều đó với `sudo userdel test_user`

[Tập lệnh mẫu](https://github.com/vntechies/90DaysOfDevOps/blob/main/2022/Days/Linux/create-user.sh)
...
Hẹn gặp lại vào [ngày 20](https://vntechies.dev/courses/90-ngay-devops/ngay-20-thiet-lap-may-tram-phat-trien).
