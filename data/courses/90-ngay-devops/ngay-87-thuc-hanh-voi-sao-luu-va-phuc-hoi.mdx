---
title: 'Ngày 87 - Thực hành với sao lưu & phục hồi'
images: ['/static/images/ogps/90daysofdevopsd87.png']
summary: 'Thực hành với sao lưu & phục hồi trên Kubernetes cluster'
...
Trong phần này, tôi muốn đi sâu vào thế giới sao lưu Kubernetes. Đây là một nền tảng mà chúng ta đã đề cập đến trong [Bức tranh toàn cảnh: Kubernetes](https://www.vntechies.dev/courses/90-ngay-devops/ngay-49-buc-tranh-toan-canh-kubernetes) trước đó.
...
![](/static/images/assets/Day87_Data1.png)
...
![](/static/images/assets/Day87_Data3.png)
...
Bạn có thể tìm thấy tệp cấu hình YAML cho ứng dụng này tại đây -> [pacman-stateful-demo.yaml](https://github.com/vntechies/90DaysOfDevOps/blob/main/2022/Days/Kubernetes/pacman-stateful-demo.yaml)

![](/static/images/assets/Day87_Data8.png)
...
![](/static/images/assets/Day87_Data14.png)

Cho demo này, tôi sẽ để mọi thứ mặc định

![](/static/images/assets/Day87_Data15.png)
...
![](/static/images/assets/Day87_Data16.png)
...
![](/static/images/assets/Day87_Data17.png)
...
![](/static/images/assets/Day87_Data23.png)
...
Hẹn gặp lại vào [ngày 88](https://vntechies.dev/courses/90-ngay-devops/ngay-88-sao-luu-theo-huong-tap-trung-vao-ung-dung)
