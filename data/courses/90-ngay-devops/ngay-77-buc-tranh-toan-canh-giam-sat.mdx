---
title: 'Ngày 77 - Bức tranh toàn cảnh: Giám sát'
images: ['/static/images/ogps/90daysofdevopsd77.png']
summary: 'Tổng quan về Giám sát trong DevOps và lý do tại sao chúng ta cần nó trong hệ thống'
tags: ['devops', '90daysofdevops', 'observability', 'monitoring']
date: '2024-02-08'
index: 77
chapter: 'Tuần 12'
---
...
![](/static/images/assets/Day77_Monitoring3.png)
...
Hẹn gặp lại vào [ngày 78](https://vntechies.dev/courses/90-ngay-devops/ngay-78-thuc-hanh-voi-cong-cu-giam-sat).
