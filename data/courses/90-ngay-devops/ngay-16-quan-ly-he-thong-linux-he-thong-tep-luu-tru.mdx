---
title: 'Ngày 16 - Quản lý Hệ thống Linux, Hệ thống Tệp & Lưu trữ'
images: ['/static/images/ogps/90daysofdevopsd16.png']
summary: 'Các câu lệnh/công cụ quản lý hệ thống, hệ thống tệp và lưu trữ trên Linux.'
...
Tính cho đến thời điểm này, chúng ta đã có cái nhìn tổng quan ngắn gọn về Linux và DevOps. Sau đó chúng ta đã thiết lập môi trường thử nghiệm của mình sử dụng Vagrant trong [Ngày 14](https://vntechies.dev/courses/90-ngay-devops/ngay-14-buc-tranh-lon-devops-va-linux), cuối cùng chúng ta đã đề cập đến một phần nhỏ các lệnh được sử dụng hàng ngày khi làm việc với terminal vào [Ngày 15](https://vntechies.dev/courses/90-ngay-devops/ngay-15-cac-lenh-linux-cho-devops).
...
![](/static/images/assets/Day16_Linux1.png)
...
![](/static/images/assets/Day16_Linux2.png)
...
![](/static/images/assets/Day16_Linux5.png)
...
![](/static/images/assets/Day16_Linux6.png)
...
![](/static/images/assets/Day16_Linux7.png)
...
![](/static/images/assets/Day16_Linux8.png)
...
![](/static/images/assets/Day16_Linux13.png)

- `/lib` - Chúng ta đã đề cập rằng `/bin` là nơi chứa các tệp nhị phân và tệp thực thi của chúng ta, và `/lib` là nơi bạn sẽ tìm thấy các thư viện dùng chung cho các tệp đó.

![](/static/images/assets/Day16_Linux14.png)

- `/media` - Đây là nơi chúng ta sẽ tìm thấy các thiết bị di động.

![](/static/images/assets/Day16_Linux15.png)

- `/mnt` - Đây là điểm gắn kết tạm thời. Chúng ta sẽ đề cập sâu hơn trong phần tiếp theo về lưu trữ.

![](/static/images/assets/Day16_Linux16.png)
...
![](/static/images/assets/Day16_Linux21.png)

- `/tmp` - tệp tạm thời.

![](/static/images/assets/Day16_Linux22.png)
...
![](/static/images/assets/Day16_Linux23.png)
...
![](/static/images/assets/Day16_Linux25.png)
...
![](/static/images/assets/Day16_Linux26.png)
...
Hẹn gặp lại trong [ngày 17](https://vntechies.dev/courses/90-ngay-devops/ngay-17-text-ediors-nano-vs-vim).
