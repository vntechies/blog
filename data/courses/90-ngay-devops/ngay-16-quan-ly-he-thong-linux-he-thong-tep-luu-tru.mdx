...
images: ['/static/images/ogps/90daysofdevopsd16.jpeg']
...
Tính cho đến thời điểm này, chúng ta đã có cái nhìn tổng quan ngắn gọn về Linux và DevOps. Sau đó chúng ta đã thiết lập môi trường thử nghiệm của mình sử dụng Vagrant trong [Ngày 14](/courses/90-ngay-devops/ngay-14-buc-tranh-lon-devops-va-linux), cuối cùng chúng ta đã đề cập đến một phần nhỏ các lệnh được sử dụng hàng ngày khi làm việc với terminal vào [Ngày 15](/courses/90-ngay-devops/ngay-15-cac-lenh-linux-cho-devops).
...
Hẹn gặp lại trong [ngày 17](/courses/90-ngay-devops/ngay-17-text-ediors-nano-vs-vim).
