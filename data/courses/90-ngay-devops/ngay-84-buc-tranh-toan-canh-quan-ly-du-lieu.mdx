---
title: 'Ngày 84 - Bức tranh toàn cảnh: Quản lý dữ liệu'
images: ['/static/images/ogps/90daysofdevopsd84.png']
summary: 'Giới thiệu về dịch vụ dữ liệu và các loại cơ sở dữ liệu'
...
![](/static/images/assets/Day84_Data1.png)
...
Hẹn gặp lại vào [ngày 85](https://vntechies.dev/courses/90-ngay-devops/ngay-85-dich-vu-du-lieu)
