---
title: 'Ngày 66 - Tiếp tục với Ansible Playbooks...'
images: ['/static/images/ogps/90daysofdevopsd66.png']
summary: 'Phần tiếp theo ansible playbooks, với roles và ansible galaxy'
...
![](/static/images/assets/Day66_config1.png)
...
sau đó, trong playbook mà hiện tại có tên là `playbook2.yml`, chúng ta trỏ đến các tệp này. Tất cả đều có thể được tìm thấy tại [ansible-scenario2](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/Days/Configmgmt/ansible-scenario2/)
...
![](/static/images/assets/Day66_config2.png)

Hãy xem tôi đã thực hiện thay đổi nào. Sử dụng lệnh `curl web01:8000`

![](/static/images/assets/Day66_config3.png)
...
![](/static/images/assets/Day66_config4.png)
...
![](/static/images/assets/Day66_config5.png)
...
![](/static/images/assets/Day66_config6.png)
...
![](/static/images/assets/Day66_config7.png)
...
![](/static/images/assets/Day66_config8.png)
...
![](/static/images/assets/Day66_config9.png)

Bạn có thể tìm thấy các tệp này trong[ansible-scenario3](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/Days/Configmgmt/ansible-scenario3)
...
![](/static/images/assets/Day66_config10.png)
...
Hẹn gặp lại vào [ngày 67](https://vntechies.dev/courses/90-ngay-devops/ngay-67-su-dung-role-trien-khai-load-balancer).
