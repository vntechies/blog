---
title: 'Ngày 59 - Tạo máy ảo với Terraform và biến'
images: ['/static/images/ogps/90daysofdevopsd59.png']
summary: 'Trong bài này, chúng ta sẽ tạo một hoặc hai máy ảo bằng cách sử dụng terraform trong VirtualBox'
...
![](/static/images/assets/Day59_IAC1.png)
...
![](/static/images/assets/Day59_IAC2.png)

Trong Virtualbox, bạn sẽ nhìn thấy 2 máy ảo mới được khởi tạo.

![](/static/images/assets/Day59_IAC3.png)
...
![](/static/images/assets/Day59_IAC6.png)
...
Hẹn gặp lại các bạn vào ngày tiếp theo [ngày 60](https://vntechies.dev/courses/90-ngay-devops/ngay-60-docker-container-providers-modules)
