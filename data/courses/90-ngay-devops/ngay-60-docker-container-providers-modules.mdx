---
title: 'Ngày 60 - Docker Containers, Provisioners & Modules'
images: ['/static/images/ogps/90daysofdevopsd60.png']
summary: 'Trong bài này, chúng ta sẽ triển khai một Docker container với một số cấu hình đến môi trường Docker tại máy tính cá nhân.'
...
Trong [ngày 59](https://vntechies.dev/courses/90-ngay-devops/ngay-59-tao-vm-voi-terraform-bien), chúng ta đã cung cấp một máy ảo bằng cách sử dụng Terraform đến môi trường VirtualBox FREE tại máy tính cá nhân. Trong phần này, chúng ta sẽ triển khai một Docker container với một số cấu hình đến môi trường Docker tại máy tính cá nhân của chúng ta.
...
![](/static/images/assets/Day60_IAC3.png)
...
![](/static/images/assets/Day60_IAC4.png)
...
![](/static/images/assets/Day60_IAC5.png)
...
![](/static/images/assets/Day60_IAC6.png)
...
Hẹn gặp lại các bạn vào [Ngày 61](https://vntechies.dev/courses/90-ngay-devops/ngay-61-kubernetes-da-moi-truong)
