---
title: 'Ngày 53 - Tổng quan về Rancher - Thực hành'
images: ['/static/images/ogps/90daysofdevopsd53.png']
...
![](/static/images/assets/Day53_Kubernetes1.png)
...
![](/static/images/assets/Day53_Kubernetes2.png)
...
![](/static/images/assets/Day53_Kubernetes5.png)
...
![](/static/images/assets/Day53_Kubernetes6.png)
...
![](/static/images/assets/Day53_Kubernetes7.png)
...
![](/static/images/assets/Day53_Kubernetes8.png)

### Tạo một cluster mới

Trong hai ngày vừa qua, chúng ta đã tạo một minikube cluster và đã sử dụng Vagrant với VirtualBox để tạo một Kubernetes cluster gồm 3 nodes. Với Rancher, chúng ta cũng có thể tạo cluster. Trong [thư mục Rancher](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/Days/Kubernetes/Rancher) bạn sẽ thấy các tệp vagrant tạo ra 3 nodes giống nhau nhưng không có các bước tạo Kubernetes cluster của chúng ta (chúng ta muốn Rancher làm điều này cho chúng ta)
...
![](/static/images/assets/Day53_Kubernetes9.png)
...
![](/static/images/assets/Day53_Kubernetes10.png)
...
![](/static/images/assets/Day53_Kubernetes11.png)
...
![](/static/images/assets/Day53_Kubernetes12.png)
...
![](/static/images/assets/Day53_Kubernetes13.png)
...
![](/static/images/assets/Day53_Kubernetes14.png)
...
Hẹn gặp lại vào [ngày 54](https://vntechies.dev/courses/90-ngay-devops/ngay-54-trien-khai-ung-dung-kubernetes).
