---
title: 'Ngày 69 - Tất cả những thứ còn lại của Ansible - Automation Controller, AWX, Vault'
images: ['/static/images/ogps/90daysofdevopsd69.png']
summary: 'Giới thiệu về Automation Controller, AWX, Vault và các tài liệu hữu ích khi sử dụng Ansible'
...
![](/static/images/assets/Day69_config1.png)
...
![](/static/images/assets/Day69_config2.png)
...
![](/static/images/assets/Day69_config5.png)
...
![](/static/images/assets/Day69_config6.png)
...
![](/static/images/assets/Day69_config7.png)
...
![](/static/images/assets/Day69_config8.png)
...
![](/static/images/assets/Day69_config9.png)
...
![](/static/images/assets/Day69_config10.png)
...
Hẹn gặp lại vào [Ngày 70](https://vntechies.dev/courses/90-ngay-devops/ngay-70-buc-tranh-toan-canh-ci-cd).
