---
title: 'Ngày 47 - Docker Networking & Security'
images: ['/static/images/ogps/90daysofdevopsd47.png']
summary: 'Xem xét cách mọi thứ hoạt động với Docker từ góc độ network và đề cập tới các vấn đề bảo mật'
...
![](/static/images/assets/Day47_Containers1.png)
...
![](/static/images/assets/Day47_Containers2.png)
...
![](/static/images/assets/Day47_Containers3.png)
...
![](/static/images/assets/Day47_Containers4.png)
...
![](/static/images/assets/Day47_Containers5.png)
...
![](/static/images/assets/Day47_Containers6.png)
...
![](/static/images/assets/Day47_Containers7.png)

Xem lại trạng thái của container và port mapping bằng cách chạy `docker ps`

![](/static/images/assets/Day47_Containers8.png)
...
![](/static/images/assets/Day47_Containers9.png)
...
![](/static/images/assets/Day47_Containers10.png)
...
Chúng ta có thể thêm một vài bước vào quy trình của chúng ta để sử dụng người dùng không phải root như một thực hành tốt nhất mà chúng ta ưu tiên. Khi tạo các tệp dockerfile, chúng ta có thể tạo tài khoản người dùng. Bạn cũng có thể tìm thấy ví dụ này trong [thư mục container](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/Days/Containers/Dockerfile)
...
![](/static/images/assets/Day47_Containers11.png)
...
Hẹn gặp lại vào [ngày 48](https://vntechies.dev/courses/90-ngay-devops/ngay-48-cac-lua-chon-thay-the-cho-docker)
