---
title: 'Ngày 48 - Các lựa chọn thay thế cho Docker'
images: ['/static/images/ogps/90daysofdevopsd48.png']
summary: 'Các lựa chọn thay thế cho Docker và các công cụ hữu dụng cho Docker'
...
![](/static/images/assets/Day48_Containers1.png)
...
![](/static/images/assets/Day48_Containers2.png)
...
![](/static/images/assets/Day48_Containers3.png)
...
Hẹn gặp lại vào [ngày 49](https://vntechies.dev/courses/90-ngay-devops/ngay-49-buc-tranh-toan-canh-kubernetes).
