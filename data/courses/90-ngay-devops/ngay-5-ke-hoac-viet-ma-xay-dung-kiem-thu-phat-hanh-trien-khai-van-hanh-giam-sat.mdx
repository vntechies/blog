---
title: 'Ngày 5 - Kế hoạch > Viết mã > Xây dựng > Kiểm thử > Phát hành > Triển khai > Vận hành > Giám sát >'
draft: false
layout: CourseSimple
images: ['/static/images/ogps/90daysofdevopsd5.png']
summary: 'Tìm hiểu những câu chuyện thực tế khi áp dụng các phương pháp, văn hoá DevOps của các doanh nghiệp lớn'
...
Phần cuối cùng này là một chút tóm tắt nội dung của [ngày thứ 3](https://vntechies.dev/courses/90-ngay-devops/ngay-3-vong-doi-devops-tap-trung-vao-ung-dung) nhưng qua bài viết này, tôi nghĩ rằng mọi thứ trở nên rõ ràng hơn.
...
Nếu bạn đã đi được tới đây, bạn chắn hẳn đã biết rõ liệu đây có phải là hành trình bạn muốn theo đuổi hay không. Hẹn gặp lại vào [ngày 6](https://vntechies.dev/courses/90-ngay-devops/ngay-6-devops-nhung-cau-chuyen-thuc-te).
