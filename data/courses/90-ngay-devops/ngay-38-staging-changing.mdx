---
title: 'Ngày 38 - Staging & Changing'
images: ['/static/images/ogps/90daysofdevopsd38.png']
summary: 'Stage và commit, những khái niệm, câu lệnh đầu tiên cho các thay đổi với Git'
...
![](/static/images/assets/Day38_Git3.png)
...
![](/static/images/assets/Day38_Git4.png)
...
![](/static/images/assets/Day38_Git5.png)
...
Chúng ta có thể lặp lại các quy trình của mình như trước đó, tạo hoặc chỉnh sửa tệp của mình > `git add .` để thêm tất cả các file vào khu vực staging sau đó sử dụng `git commit -m "meaningful message"`. Nhưng để đưa ra một thông điệp có ý nghĩa cho thay đổi trong commit của mình, bạn có lẽ không nên viết ra những thứ như

```shell
git commit -m "Chà, tôi đã thay đổi một số mã vì nó không hoạt động và khi tôi sửa mã đó, tôi cũng đã thêm một số thứ mới trong readme.md để đảm bảo rằng mọi người đều biết về trải nghiệm của người dùng và sau đó tôi pha một ấm trà."
```

Ý tôi là điều này cũng có thể sẽ hiệu quả mặc dù hơi dài dòng nhưng các tốt hơn ở đây là nên thêm thông điệp bằng một trình soạn thảo văn bản.
...
![](/static/images/assets/Day38_Git8.png)
...
![](/static/images/assets/Day38_Git9.png)
...
![](/static/images/assets/Day38_Git10.png)
...
![](/static/images/assets/Day38_Git11.png)
...
![](/static/images/assets/Day38_Git12.png)
...
![](/static/images/assets/Day38_Git13.png)
...
![](/static/images/assets/Day38_Git14.png)

Sau đó chúng ta có thể kiểm tra `git status` và xem điều gì đã xảy ra.

![](/static/images/assets/Day38_Git15.png)
...
![](/static/images/assets/Day38_Git16.png)
...
Hẹn gặp lại vào [ngày 39](https://vntechies.dev/courses/90-ngay-devops/ngay-39-xem-unstaging-loai-bo-khoi-phuc)
