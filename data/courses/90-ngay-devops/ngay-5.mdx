...
summary: 'Kế hoạch > Viết mã > Xây dựng > Kiểm thử > Phát hành > Triển khai > Vận hành > Giám sát > . Hôm nay chúng ta sẽ tập trung vào các bước riêng lẻ và chu trình liên tục của một ứng dụng từ đầu đến cuối trong thế giới DevOps.'
...
Phần cuối cùng này là một chút tóm tắt nội dung của [ngày thứ 3](/courses/90-ngay-devops/ngay-3) nhưng qua bài viết này, tôi nghĩ rằng mọi thứ trở nên rõ ràng hơn.
...
Nếu bạn đã đi được tới đây, bạn chắn hẳn đã biết rõ liệu đây có phải là hành trình bạn muốn theo đuổi hay không. Hẹn gặp lại vào [ngày 6](/courses/90-ngay-devops/ngay-6).
