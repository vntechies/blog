---
title: 'Ngày 20 - Thiết lập máy trạm phát triển - những điều tuyệt vời'
images: ['/static/images/ogps/90daysofdevopsd20.png']
summary: 'Hướng dẫn các cài đặt zsh và ohmyzsh để biến shell của bạn nhanh và đẹp hơn theo sở thích cá nhân.'
...
[![Nhấp để truy cập Video YouTube](/static/images/assets/Day20_YouTube.png)](https://youtu.be/jeEslAtHfKc)

Cuối cùng, hệ thống của chúng ta sẽ trông giống như bên dưới:

![](/static/images/assets/Day20_Linux1.png)

Chúng ta cũng có thể thấy bash shell mặc định của mình bên dưới:

![](/static/images/assets/Day20_Linux2.png)
...
![](/static/images/assets/Day20_Linux3.png)
...
![](/static/images/assets/Day20_Linux4.png)

Tôi đã chọn `1` cho câu hỏi trên và bây giờ chúng ta có thêm một số tùy chọn.

![](/static/images/assets/Day20_Linux5.png)
...
![](/static/images/assets/Day20_Linux6.png)
...
![](/static/images/assets/Day20_Linux7.png)
...
![](/static/images/assets/Day20_Linux8.png)
...
[![](/static/images/assets/Day20_YouTube.png)](https://youtu.be/jeEslAtHfKc)
...
Hẹn gặp lại vào [ngày 21](https://vntechies.dev/courses/90-ngay-devops/ngay-21-buc-tranh-toan-canh-devops-va-mang-may-tinh).
