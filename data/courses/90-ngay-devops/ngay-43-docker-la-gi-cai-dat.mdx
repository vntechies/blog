---
title: 'Ngày 43 - Docker là gì & Cài đặt'
images: ['/static/images/ogps/90daysofdevopsd43.png']
summary: 'Chúng ta sẽ sử dụng và giải thích về Docker cũng như cách cài đặt các công cụ để làm việc với Docker.'
...
![](/static/images/assets/Day43_Containers1.png)
...
![](/static/images/assets/Day43_check.png)
...
Hẹn gặp lại vào [ngày 44](https://vntechies.dev/courses/90-ngay-devops/ngay-44-docker-images-thuc-hanh-voi-docker-desktop)
