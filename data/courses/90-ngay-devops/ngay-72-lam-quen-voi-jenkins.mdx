---
title: 'Ngày 72 - Làm quen với Jenkins'
images: ['/static/images/ogps/90daysofdevopsd72.png']
summary: 'Jenkins Pipeline là gì và cách triển khai Jenkins'
tags: ['devops', '90daysofdevops', 'CI/CD Pipelines']
date: '2023-09-11'
index: 72
chapter: 'Tuần 11'
---
...
![](/static/images/assets/Day71_CICD4.png)
...
![](/static/images/assets/Day72_CICD1.png)

Tôi đã thêm một thư mục với tất cả giá trị và cấu hình YAML có thể thấy ở [đây](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/es/Days/CICD/Jenkins). Bây giờ chúng ta đã có cụm riêng và có thể chạy lệnh sau đây để tạo không gian tên jenkins. `kubectl create -f`

![](/static/images/assets/Day72_CICD2.png)
...
![](/static/images/assets/Day72_CICD3.png)
...
![](/static/images/assets/Day72_CICD4.png)
...
![](/static/images/assets/Day72_CICD5.png)
...
![](/static/images/assets/Day72_CICD6.png)
...
![](/static/images/assets/Day72_CICD7.png)
...
![](/static/images/assets/Day72_CICD8.png)
...
![](/static/images/assets/Day72_CICD9.png)
...
![](/static/images/assets/Day72_CICD10.png)
...
![](/static/images/assets/Day72_CICD11.png)
...
![](/static/images/assets/Day72_CICD14.png)
...
![](/static/images/assets/Day72_CICD15.png)
...
Hẹn gặp lại vào [Ngày 73](https://vntechies.dev/courses/90-ngay-devops/ngay-73-xay-dung-jenkins-pipeline)
