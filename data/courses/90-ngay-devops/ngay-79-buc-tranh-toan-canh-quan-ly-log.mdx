---
title: 'Ngày 79 - Bức tranh toàn cảnh: Quản lý log'
images: ['/static/images/ogps/90daysofdevopsd79.png']
summary: 'Giới thiệu vai trò và cách thức tổng hợp log trong quản lý hiệu suất ứng dụng và giám sát hạ tầng để chẩn đoán sự cố hiệu quả'
tags: ['devops', '90daysofdevops', 'observability', 'monitoring', 'log', 'kubernetes']
date: '2024-06-23'
index: 79
chapter: 'Tuần 12'
---
...
Hẹn gặp lại vào [ngày 80](https://vntechies.dev/courses/90-ngay-devops/ngay-80-elk-stack).
