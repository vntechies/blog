---
title: 'Ngày 90 - Dữ liệu & ứng dụng: Tính di động'
images: ['/static/images/ogps/90daysofdevopsd90.png']
summary: 'Tính di động của dữ liệu và ứng dụng trên đa nền tảng'
...
Nó sử dụng nhiều đặc điểm mà chúng ta đã thảo luận trong [Khôi phục Thảm họa](https://vntechies.dev/courses/90-ngay-devops/ngay-89-khac-phuc-tham-hoa-dr)
...
![](/static/images/assets/Day90_Data3.png)
...
![](/static/images/assets/Day90_Data4.png)

Chọn tùy chọn "Apply transforms to restored resources".

![](/static/images/assets/Day90_Data5.png)
...
![](/static/images/assets/Day90_Data6.png)
...
![](/static/images/assets/Day90_Data11.png)

Một lần nữa, chúng ta sẽ được yêu cầu xác nhận các hành động.

![](/static/images/assets/Day90_Data12.png)
...
![](/static/images/assets/Day90_Data13.png)
