---
title: 'Ngày 62 - Kiểm thử, Công cụ và Các phương pháp thay thế'
images: ['/static/images/ogps/90daysofdevopsd62.png']
summary: 'Bài viết trình bày về việc kiểm thử và các công cụ liên quan tới terraform và các lựa chọn thay thế của nó'
...
Hẹn gặp lại các bạn ở [ngày 63](https://vntechies/dev/courses/90-ngay-devops/ngay-63-buc-tranh-toan-canh-quan-ly-cau-hinh).
