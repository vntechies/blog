---
title: 'Ngày 13 - Tweet tiến trình của bạn với ứng dụng mới của chúng ta'
images: ['/static/images/ogps/90daysofdevopsd13.png']
summary: 'Vào ngày cuối cùng tìm hiểu về ngôn ngữ lập trình Go, chúng ta mới chỉ tìm hiểu qua về những vấn đề nổi bật của ngôn ngữ này nhưng đó sẽ là lúc mà chúng ta cần hứng thú và hào hứng để có thể tìm hiểu sâu hơn về nó.'
...
![](/static/images/assets/Day13_Go1.png)
...
![](/static/images/assets/Day13_Go2.png)

Đặt tên cho ứng dụng của bạn

![](/static/images/assets/Day13_Go3.png)
...
![](/static/images/assets/Day13_Go4.png)
...
![](/static/images/assets/Day13_Go5.png)
...
![](/static/images/assets/Day13_Go6.png)
...
Đây là mà chúng ta bắt đầu trong ứng dụng của mình [day13_example1](https://github.com/vntechies/90DaysOfDevOps/blob/main/2022/Days/Go/day13_example1.go) nhưng trước tiên, chúng ta cần kiểm tra xem mã có đúng để tạo một tweet không
...
Ở giai đoạn này, bạn có thể xem mã tại [day13_example2](https://github.com/vntechies/90DaysOfDevOps/blob/main/2022/Days/Go/day13_example2.go) nhưng bạn sẽ thấy ở đây rằng chúng ta sẽ sử dụng một cấu trúc (struct) để khai báo khóa, secrts và tokens.
...
Bạn có thể xem được mã đã được gộp tại [day13_example3](https://github.com/vntechies/90DaysOfDevOps/blob/main/2022/Days/Go/day13_example3.go) hoặc dưới đây.
...
![](/static/images/assets/Day13_Go7.png)
...
![](/static/images/assets/Day13_Go8.png)

Tweet kết quả sẽ trông giống như sau:

![](/static/images/assets/Day13_Go9.png)
...
Các câu lệnh này sẽ cung cấp cho bạn các tệp nhị phân cho tất cả các nền tảng ở trên. Sau đó, bạn có thể lấy tệp này và tạo một makefile để tạo các tệp nhị phân này bất cứ khi nào bạn thêm các tính năng và chức năng mới vào mã của mình. Tôi đã bao gồm [makefile](https://github.com/vntechies/90DaysOfDevOps/blob/main/2022/Days/Go/makefile)
...
Hẹn gặp lại các bạn vào [Ngày 14](https://vntechies.dev/courses/90-ngay-devops/ngay-14-buc-tranh-lon-devops-va-linux).
