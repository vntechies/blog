...
Đây là mà chúng ta bắt đầu trong ứng dụng của mình [day13_example1](https://github.com/vntechies/90DaysOfDevOps/blob/main/Days/Go/day13_example1.go) nhưng trước tiên, chúng ta cần kiểm tra xem mã có đúng để tạo một tweet không
...
Ở giai đoạn này, bạn có thể xem mã tại [day13_example2](https://github.com/vntechies/90DaysOfDevOps/blob/main/Days/Go/day13_example2.go) nhưng bạn sẽ thấy ở đây rằng chúng ta sẽ sử dụng một cấu trúc (struct) để khai báo khóa, secrts và tokens.
...
Bạn có thể xem được mã đã được gộp tại [day13_example3](https://github.com/vntechies/90DaysOfDevOps/blob/main/Days/Go/day13_example3.go) hoặc dưới đây.
