---
title: 'Ngày 31 - Mô hình Điện toán Microsoft Azure'
images: ['/static/images/ogps/90daysofdevopsd31.png']
summary: 'Hôm nay chúng ta sẽ xem xét các dịch vụ điện toán khác nhau có sẵn trong Azure'
...
Hẹn gặp lại vào [ngày 32](https://vntechies.dev/courses/90-ngay-devops/ngay-32-mo-hinh-luu-tru-va-co-so-du-lieu-microsoft-azure)
