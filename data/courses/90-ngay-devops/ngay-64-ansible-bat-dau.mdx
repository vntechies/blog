---
title: 'Ngày 64 - Ansible: Bắt đầu'
images: ['/static/images/ogps/90daysofdevopsd64.png']
summary: 'Bài viết trình bày về Ansible và các khái niệm cơ bản'
...
Đối với node điều khiển của tôi và ít nhất là bài demo, tôi sẽ sử dụng máy ảo Linux mà chúng ta đã tạo lại trong [phần Linux](https://vntechies.dev/courses/90-ngay-devops/ngay-20-thiet-lap-may-tram-phat-trien) làm node điều khiển của mình.
...
![](/static/images/assets/Day64_config1.png)
...
![](/static/images/assets/Day64_config2.png)

Hoặc cách sử dụng thực tế cho một module có thể là `ansible webservers -m service -a "name=httpd state=started"` điều này sẽ cho chúng ta biết liệu tất cả máy chủ web của chúng ta có dịch vụ httpd đang chạy hay không. Thuật ngữ máy chủ web được sử dụng trong lệnh đó.
...
![](/static/images/assets/Day64_config3.png)
...
![](/static/images/assets/Day64_config4.png)
...
![](/static/images/assets/Day64_config5.png)
...
![](/static/images/assets/Day64_config6.png)
...
Hẹn gặp lại vào [ngày 65](https://vntechies.dev/courses/90-ngay-devops/ngay-65-ansible-playbooks).
