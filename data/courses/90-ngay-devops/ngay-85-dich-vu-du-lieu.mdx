---
title: 'Ngày 85 - Dịch vụ dữ liệu'
images: ['/static/images/ogps/90daysofdevopsd85.png']
summary: 'Việc chọn dịch vụ dữ liệu hoặc cơ sở dữ liệu phù hợp là quyết định quan trọng đối với hiệu suất và khả năng mở rộng của ứng dụng.'
...
![](/static/images/assets/Day85_Data1.png)
...
![](/static/images/assets/Day85_Data2.png)
...
![](/static/images/assets/Day85_Data3.png)
...
![](/static/images/assets/Day85_Data4.png)
...
Hẹn gặp lại vào [ngày 86](https://vntechies.dev/courses/90-ngay-devops/ngay-86-sao-luu-tat-ca-cac-nen-tang)
