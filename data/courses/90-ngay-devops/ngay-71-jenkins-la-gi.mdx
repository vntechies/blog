---
title: 'Ngày 71 - Jenkins là gì?'
images: ['/static/images/ogps/90daysofdevopsd71.png']
summary: 'Giới thiệu về Jenkins, kiến trúc và đặc điểm của công cụ này'
...
![](/static/images/assets/Day71_CICD1.png)
...
![](/static/images/assets/Day71_CICD2.png)
...
![](/static/images/assets/Day71_CICD3.png)
...
![](/static/images/assets/Day71_CICD5.png)
...
Hẹn gặp lại vào [Ngày 72](https://vntechies.dev/courses/90-ngay-devops/ngay-72-lam-quen-voi-jenkins).
