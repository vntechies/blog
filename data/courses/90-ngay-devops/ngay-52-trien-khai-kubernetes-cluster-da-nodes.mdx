---
title: 'Ngày 52 - Thiết lập Kubernetes cluster đa node'
images: ['/static/images/ogps/90daysofdevopsd52.png']
summary: 'Trong bài viết này, chúng ta sẽ sử dụng VirtualBox và vagrant để triển khai một Kubernetes cluster đa nodes'
...
Trong bài ngày hôm nay, chúng ta sẽ sử dụng VirtualBox làm cơ sở nhưng như đã đề cập ở lần trước khi chúng ta nói về Vagrant trong phần về Linux, chúng ta có thể sử dụng bất kỳ công cụ ảo hoá nào được hỗ trợ. Đó là [ngày 14](https://vntechies.dev/courses/90-ngay-devops/ngay-14-buc-tranh-lon-devops-va-linux) khi chúng ta xem xét và triển khai máy chủ Ubuntu.
...
![](/static/images/assets/Day52_Kubernetes1.png)
...
![](/static/images/assets/Day52_Kubernetes2.png)

Từ những điều trên, bạn có thể thấy rằng chúng ta sẽ xây dựng 3 máy ảo, chúng ta sẽ có một sẽ có một control plane node và 2 worker nodes. Nếu bạn qua lại [ngày 49](https://vntechies.dev/courses/90-ngay-devops/ngay-49-buc-tranh-toan-canh-kubernetes), bạn có thể đọc lại về những phần trong hình ảnh trên.
...
![](/static/images/assets/Day52_Kubernetes3.png)
...
![](/static/images/assets/Day52_Kubernetes4.png)
...
![](/static/images/assets/Day52_Kubernetes5.png)
...
![](/static/images/assets/Day52_Kubernetes8.png)
...
Hẹn gặp lại vào [ngày 53](https://vntechies.dev/courses/90-ngay-devops/ngay-53-tong-quan-ve-rancher-thuc-hanh).
