---
title: 'Ngày 34 - Thực hành với Microsoft Azure'
images: ['/static/images/ogps/90daysofdevopsd34.png']
summary: 'Chọn và thực hành các tình huống cơ bản với Microsoft Azure.'
...
Trước hết, tôi chạy [PowerShell script](https://github.com/vntechies/90DaysOfDevOps/blob/main/2022/Days/Cloud/01VirtualNetworking/Module4_90DaysOfDevOps.ps1) của mình

![](/static/images/assets/Day34_Cloud1.png)

- Nhiệm vụ 1: Tạo và cấu hình mạng ảo

![](/static/images/assets/Day34_Cloud2.png)

- Nhiệm vụ 2: Triển khai máy ảo vào mạng ảo

![](/static/images/assets/Day34_Cloud3.png)

- Nhiệm vụ 3: Cấu hình địa chỉ IP private và public của máy ảo Azure

![](/static/images/assets/Day34_Cloud4.png)

- Nhiệm vụ 4: Cấu hình các network security groups

![](/static/images/assets/Day34_Cloud5.png)
![](/static/images/assets/Day34_Cloud6.png)

- Nhiệm vụ 5: Cấu hình Azure DNS để phân giải tên nội bộ

![](/static/images/assets/Day34_Cloud7.png)
![](/static/images/assets/Day34_Cloud8.png)
...
Đầu tiên tôi chạy [PowerShell script](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/Days/Cloud/02TrafficManagement/Mod06_90DaysOfDevOps.ps1) của mình

![](/static/images/assets/Day34_Cloud9.png)

- Nhiệm vụ 2: Cấu hình topo mạng cho mạng hub-spoke

![](/static/images/assets/Day34_Cloud10.png)
...
![](/static/images/assets/Day34_Cloud11.png)
![](/static/images/assets/Day34_Cloud12.png)
![](/static/images/assets/Day34_Cloud13.png)
...
![](/static/images/assets/Day34_Cloud14.png)
![](/static/images/assets/Day34_Cloud15.png)
...
![](/static/images/assets/Day34_Cloud16.png)

- Nhiệm vụ 5: Triển khai Azure Load Balancer

![](/static/images/assets/Day34_Cloud17.png)
![](/static/images/assets/Day34_Cloud18.png)

- Nhiệm vụ 6: Triển khai Azure Application Gateway

![](/static/images/assets/Day34_Cloud19.png)
![](/static/images/assets/Day34_Cloud20.png)
...
Trước hết, tôi chạy [PowerShell script](https://github.com/vntechies/90DaysOfDevOps/blob/main/2022/Days/Cloud/03Storage/Mod07_90DaysOfDevOps.ps1) của mình

![](/static/images/assets/Day34_Cloud21.png)

- Nhiệm vụ 2: Tạo và cấu hình tài khoản Azure Storage

![](/static/images/assets/Day34_Cloud22.png)

- Nhiệm vụ 3: Quản lý lưu trữ blob

![](/static/images/assets/Day34_Cloud23.png)

- Nhiệm vụ 4: Quản lý xác thực và cấp quyền cho Azure Storage

![](/static/images/assets/Day34_Cloud24.png)
![](/static/images/assets/Day34_Cloud25.png)

Tôi hơi thiếu kiên nhẫn chờ đợi điều này được cho phép nhưng cuối cùng thì nó cũng hoạt động.

![](/static/images/assets/Day34_Cloud26.png)
...
![](/static/images/assets/Day34_Cloud27.png)
![](/static/images/assets/Day34_Cloud28.png)
![](/static/images/assets/Day34_Cloud29.png)

- Nhiệm vụ 6: Quản lý truy cập mạng cho Azure Storage

![](/static/images/assets/Day34_Cloud30.png)
...
![](/static/images/assets/Day34_Cloud31.png)

- Nhiệm vụ 2: Tạo staging deployment slot

![](/static/images/assets/Day34_Cloud34.png)

- Nhiệm vụ 3: Định cấu hình cài đặt triển khai ứng dụng web

![](/static/images/assets/Day34_Cloud33.png)

- Nhiệm vụ 4: Triển khai mã vào staging deployment slot

![](/static/images/assets/Day34_Cloud32.png)

- Nhiệm vụ 5: Đổi staging slots

![](/static/images/assets/Day34_Cloud35.png)
...
![](/static/images/assets/Day34_Cloud36.png)
...
- [AWS Basics for Beginners - Full Course](https://www.youtube.com/watch?v=HK_q1lH5x5M)
...
Hẹn gặp lại vào [ngày 35](https://vntechies.dev/courses/90-ngay-devops/ngay-35-buc-tranh-toan-canh-git-quan-ly-phien-ban).
