---
title: 'Ngày 2 - Trách nhiệm của kỹ sư DevOps'
draft: false
layout: CourseSimple
images: ['/static/images/ogps/90daysofdevopsd2.png']
summary: Trách nhiệm của kỹ sư DevOps và tổng quan về những kiến thức/kỹ năng cần có để trở thành một kỹ sư DevOps tốt
...
Hy vọng bạn tới với bài viết này sau khi đọc xong [ngày 1](https://vntechies.dev/courses/90-ngay-devops/ngay-1-gioi-thieu) của [#90ngàydevops](https://vntechies.dev/courses/90-ngay-devops/gioi-thieu)
...
Nếu bạn đã đi được tới đây, bạn chắn hẳn đã biết rõ liệu đây có phải là hành trình bạn muốn theo đuổi hay không. Hẹn gặp lại vào [ngày 3](https://vntechies.dev/courses/90-ngay-devops/ngay-3-vong-doi-devops-tap-trung-vao-ung-dung).
