---
title: 'Ngày 89 - Khôi phục thảm họa (DR)'
images: ['/static/images/ogps/90daysofdevopsd89.png']
summary: 'Khôi phục dữ liệu, ứng dụng khi thảm hoạ xảy ra'
tags: ['devops', '90daysofdevops', 'data', 'dataops']
date: '2024-07-07'
index: 89
chapter: 'Tuần 13'
---
...
Chúng ta đã đề cập đến các kịch bản sự cố khác nhau sẽ đòi hỏi các yêu cầu khôi phục khác nhau. Khi nói đến các kịch bản cháy, lũ lụt,... Chúng ta có thể xem đây là các tình huống thảm họa mà chúng ta cần phải có các ứng dụng của mình hoạt động ở một vị trí hoàn toàn khác càng nhanh càng tốt hoặc ít nhất với mục tiêu thời gian khôi phục gần như bằng không (RTO).
...
![](/static/images/assets/Day89_Data1.png)
...
![](/static/images/assets/Day87_Data4.png)
...
![](/static/images/assets/Day89_Data2.png)
...
![](/static/images/assets/Day89_Data3.png)
...
![](/static/images/assets/Day89_Data6.png)
...
![](/static/images/assets/Day89_Data7.png)
...
![](/static/images/assets/Day89_Data10.png)

Cuối cùng, chọn "Create Policy" và bạn sẽ thấy chính sách trong cửa sổ Policy.

![](/static/images/assets/Day89_Data11.png)
...
![](/static/images/assets/Day89_Data15.png)
...
![](/static/images/assets/Day89_Data21.png)
...
![](/static/images/assets/Day89_Data25.png)
...
![](/static/images/assets/Day89_Data26.png)
...
Hẹn gặp lại vào [ngày 90](https://vntechies.dev/courses/90-ngay-devops/ngay-90-du-lieu-va-ung-dung-tinh-di-dong)
