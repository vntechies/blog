...
Vào [ngày 8](/courses/90-ngay-devops/ngay-8), chúng ta đã giới thiệu qua về không gian làm việc của Go, khởi động và demo bằng chương trình `Hello #90DaysOfDevOps`. Tuy nhiên cũng nên tìm hiểu kỹ hơn về không gian làm việc Go.
...
Chúng ta cũng đã giới thiệu sơ qua về việc biên dịch mã ở [ngày 9](/courses/90-ngay-devops/ngay-9), nhưng hãy đi sâu hơn một chút.
...
Hẹn gặp lại tại [ngày 11](/courses/90-ngay-devops/ngay-11).
