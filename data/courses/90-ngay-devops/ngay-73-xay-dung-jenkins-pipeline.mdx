---
title: 'Ngày 73 - Xây dựng Jenkins pipeline'
images: ['/static/images/ogps/90daysofdevopsd73.png']
summary: 'Xây dựng Jenkins pipeline'
...
![](/static/images/assets/Day73_CICD1.png)
...
![](/static/images/assets/Day73_CICD2.png)
...
![](/static/images/assets/Day73_CICD7.png)
...
![](/static/images/assets/Day73_CICD8.png)

Chúng ta sau đó sẽ đặt tên cho item, chọn Pipeline và bấm ok.

![](/static/images/assets/Day73_CICD9.png)
...
![](/static/images/assets/Day73_CICD10.png)

Chúng ta chỉ quan tâm đến thẻ Pipeline ở cuối.

![](/static/images/assets/Day73_CICD11.png)
...
![](/static/images/assets/Day73_CICD12.png)

Tiếp theo, chúng ta sẽ chọn "Build Now" ở bên trái của trang.

![](/static/images/assets/Day73_CICD13.png)
...
Hẹn gặp lại vào [Ngày 74](https://vntechies.dev/courses/90-ngay-devops/ngay-74-hello-world-jenkinsfile-app-pipeline)
