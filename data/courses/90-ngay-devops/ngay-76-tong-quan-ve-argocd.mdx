---
title: 'Ngày 76 - Tổng quan về ArgoCD'
images: ['/static/images/ogps/90daysofdevopsd76.png']
summary: 'Giới thiệu về ArgoCD và ví dụ thực hành với minikube'
...
![](/static/images/assets/Day76_CICD4.png)
...
![](/static/images/assets/Day76_CICD5.png)

Khi đăng nhập thành công bạn sẽ thấy giao diện CD đang trống.

![](/static/images/assets/Day76_CICD6.png)
