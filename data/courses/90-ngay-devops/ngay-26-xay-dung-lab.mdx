...
Chúng ta sẽ tiếp tục thiết lập mạng mô phỏng của mình bằng phần mềm EVE-NG và sau đó hy vọng sẽ triển khai một số thiết bị và bắt đầu suy nghĩ về cách chúng ta có thể tự động hóa cấu hình của các thiết bị này. Vào [ngày 25](/courses/90-ngay-devops/ngay-25-lap-trinh-python-trong-tu-dong-hoa-mang), chúng ta đã đề cập đến việc cài đặt EVE-NG trên máy của mình bằng VMware Workstation.
...
Hẹn gặp lại các bạn vào [Ngày 27](/courses/90-ngay-devops/ngay-27-thuc-hanh-voi-python)
