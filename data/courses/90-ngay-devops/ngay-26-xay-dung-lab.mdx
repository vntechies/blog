---
title: 'Ngày 26 - Xây dựng Lab'
images: ['/static/images/ogps/90daysofdevopsd26.png']
summary: 'Chúng ta sẽ tiếp tục thiết lập mạng mô phỏng của mình bằng phần mềm EVE-NG và sau đó hy vọng sẽ triển khai một số thiết bị và bắt đầu suy nghĩ về cách chúng ta có thể tự động hóa cấu hình của các thiết bị này'
...
Chúng ta sẽ tiếp tục thiết lập mạng mô phỏng của mình bằng phần mềm EVE-NG và sau đó hy vọng sẽ triển khai một số thiết bị và bắt đầu suy nghĩ về cách chúng ta có thể tự động hóa cấu hình của các thiết bị này. Vào [ngày 25](https://vntechies.dev/courses/90-ngay-devops/ngay-25-lap-trinh-python-trong-tu-dong-hoa-mang), chúng ta đã đề cập đến việc cài đặt EVE-NG trên máy của mình bằng VMware Workstation.
...
![](/static/images/assets/Day26_Networking1.png)
...
![](/static/images/assets/Day26_Networking2.png)

Đặt tên cho lab của bạn và các mục khác là tùy chọn.

![](/static/images/assets/Day26_Networking3.png)
...
![](/static/images/assets/Day26_Networking4.png)
...
![](/static/images/assets/Day26_Networking5.png)
...
![](/static/images/assets/Day26_Networking6.png)
...
![](/static/images/assets/Day26_Networking7.png)
...
![](/static/images/assets/Day26_Networking8.png)
...
| Node    | Configuration                                                                         |
| ------- | ------------------------------------------------------------------------------------- |
| Router  | [R1](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/Days/Networking/R1)   |
| Switch1 | [SW1](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/Days/Networking/SW1) |
| Switch2 | [SW2](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/Days/Networking/SW2) |
| Switch3 | [SW3](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/Days/Networking/SW3) |
| Switch4 | [SW4](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/Days/Networking/SW4) |
...
Hẹn gặp lại các bạn vào [Ngày 27](https://vntechies.dev/courses/90-ngay-devops/ngay-27-thuc-hanh-voi-python)
