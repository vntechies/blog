---
title: 'Ngày 46 - Docker Compose'
images: ['/static/images/ogps/90daysofdevopsd46.png']
summary: 'Giới thiệu và thực hành với Docker Compose - công cụ có thể sử dụng một tệp và lệnh duy nhất để khởi tạo ứng dụng đa container.'
...
![](/static/images/assets/Day46_Containers1.png)

### Docker-Compose.yml (YAML)

Điều tiếp theo mà chúng ta đề cập đến là docker-compose.yml, bạn có thể tìm thấy trong [thư mục Container của kho lưu trữ](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/Days/Containers/my_wordpress/docker-compose.yaml). Nhưng quan trọng hơn, chúng ta cần thảo luận về YAML một chút.
...
![](/static/images/assets/Day46_Containers2.png)
...
![](/static/images/assets/Day46_Containers3.png)
...
![](/static/images/assets/Day46_Containers4.png)
...
![](/static/images/assets/Day46_Containers5.png)
...
![](/static/images/assets/Day46_Containers6.png)
...
![](/static/images/assets/Day46_Containers7.png)
...
![](/static/images/assets/Day46_Containers8.png)
...
![](/static/images/assets/Day46_Containers9.png)
...
![](/static/images/assets/Day46_Containers10.png)

Chúng ta có thể xác nhận trong Docker Desktop rằng volumes của chúng ta vẫn còn đó.

![](/static/images/assets/Day46_Containers11.png)
...
![](/static/images/assets/Day46_Containers12.png)
...
![](/static/images/assets/Day46_Containers13.png)
...
![](/static/images/assets/Day46_Containers14.png)
...
Hẹn gặp bạn vào [ngày 47](/courses/ngay-47-docker-networking-security)
