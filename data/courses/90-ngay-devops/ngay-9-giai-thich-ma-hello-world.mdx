---
title: 'Ngày 9 - Giải thích mã Hello World'
images: ['/static/images/ogps/90daysofdevopsd9.png']
summary: 'Giải thích các dòng mã trong ứng dụng Hello World được tạo trong ngày 8'
...
Trong [Ngày 8](https://vntechies.dev/courses/90-ngay-devops/ngay-8-thiet-lap-moi-truong-devops-cho-go-hello-world), chúng ta đã tiến hành cài đặt Go trên máy trạm của bạn sau đó tạo ứng dụng Go đầu tiên của mình.
...
![](/static/images/assets/Day9_Go1.png)

Bạn có thể thấy những gì chúng ta đã làm vào [Ngày 8](https://vntechies.dev/courses/90-ngay-devops/ngay-8-thiet-lap-moi-truong-devops-cho-go-hello-world) ở trên. Chúng ta đã tạo một tệp main.go đơn giản và sử dụng lệnh `go build main.go` để biên dịch ra một tệp thực thi.
...
![](/static/images/assets/Day9_Go2.png)
...
![](/static/images/assets/Day9_Go3.png)
...
![](/static/images/assets/Day9_Go4.png)
...
![](/static/images/assets/Day9_Go5.png)
...
![](/static/images/assets/Day9_Go6.png)
...
Hẹn gặp lại vào [ngày 10](https://vntechies.dev/courses/90-ngay-devops/ngay-10-khong-gian-lam-viec-cua-go).
