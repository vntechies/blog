---
title: 'Ngày 68 - Tags, Variables, Inventory & Database Server config'
images: ['/static/images/ogps/90daysofdevopsd68.png']
summary: 'Sử dụng tags, variables, inventory và triển khai một cơ sở dữ liệu với ansible'
...
Trong tệp playbook, trong trường hợp này, chúng ta đang sử dụng [ansible-scenario5](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/Days/Configmgmt/ansible-scenario5/playbook5.yml)
...
![](/static/images/assets/Day68_config1.png)
...
![](/static/images/assets/Day68_config2.png)
...
Tuy nhiên, chúng ta có thể giữ cho playbook của mình không có biến bằng cách di chuyển chúng vào một tệp riêng biệt. Chúng ta sẽ làm điều này nhưng sẽ chuyển qua thư mục [ansible-scenario6](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/Days/Configmgmt/ansible-scenario6). Trong thư mục gốc của thư mục đó, chúng ta sẽ tạo thư mục group_vars. Sau đó, chúng ta tạo một thư mục khác với tên all (tất cả các group sẽ nhận các biến này). Trong đó, chúng ta sẽ tạo một tệp có tên `common_variables.yml` và chúng ta sẽ sao chép các biến của mình từ playbook vào tệp này. Xoá chúng khỏi playbook cùng với phần `vars:`.
...
![](/static/images/assets/Day68_config5.png)
...
Chugns ta sẽ làm việc với thư mục [ansible-scenario7](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/Days/Configmgmt/ansible-scenario7).
...
![](/static/images/assets/Day68_config6.png)

Sử lỗi ở trên và chạy lại playbook thành công.

![](/static/images/assets/Day68_config7.png)
...
Hẹn gặp lại vào [ngày 69](https://vntechies.dev/courses/90-ngay-devops/ngay-69-tat-ca-nhung-thu-con-lai-cua-ansible-automation-controller-awx-vault).
