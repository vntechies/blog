...
Chúng ta đã đề cập vào [ngày 29](https://vntechies.dev/courses/90-ngay-devops/ngay-29-kien-thuc-co-ban-ve-microsoft-azure) phạm vi mà chúng ta sẽ đề cập ở đây, chúng ta có thể đặt kiểm soát RBAC của mình cho một trong những dịch vụ dưới đây.
