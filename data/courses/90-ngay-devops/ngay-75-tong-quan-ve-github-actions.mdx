---
title: 'Ngày 75 - Tổng quan về GitHub Actions'
images: ['/static/images/ogps/90daysofdevopsd75.png']
summary: 'Giới thiệu về Github actions và ví dụ thực hành'
tags: ['devops', '90daysofdevops', 'GitHub Actions']
date: '2023-10-16'
index: 75
chapter: 'Tuần 11'
---
...
![](/static/images/assets/Day75_CICD1.png)
...
**github/super-linter**
Bạn có thể thấy phía trên rằng đối với một trong các bước của chúng ta, chúng ta có một action được gọi là `GitHub/super-linter` và điều này đang tham chiếu đến một step đã được cộng đồng viết trước đó. Bạn có thể tìm hiểu thêm về nó tại đây [Super-Linter](https://github.com/github/super-linter)
...
![](/static/images/assets/Day75_CICD2.png)
...
![](/static/images/assets/Day75_CICD3.png)
...
![](/static/images/assets/Day75_CICD4.png)
...
![](/static/images/assets/Day75_CICD5.png)
...
![](/static/images/assets/Day75_CICD6.png)
...
![](/static/images/assets/Day75_CICD7.png)
...
![](/static/images/assets/Day75_CICD8.png)
...
Hẹn gặp lại vào [Ngày 76](https://vntechies.dev/courses/90-ngay-devops/ngay-76-tong-quan-ve-argocd)
