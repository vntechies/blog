---
title: 'Ngày 49 - Bức tranh toàn cảnh: Kubernetes'
images: ['/static/images/ogps/90daysofdevopsd49.png']
summary: 'Các khái niệm cơ bản về container orchestrator và cụ thể là Kubernetes, vai trò, tác dụng của nó trong việc triển khai ứng dụng'
...
Tôi đã đề cập tới Kubernetes và tôi đã đề cập tới Container Orchestration, Kubernetes là công nghệ trong khi điều phối container là khái niệm, quy trình phía sau công nghệ đó. Kubernetes không phải là nền tẳng Điều phối container duy nhất mà chúng ta còn có Docker Swarm, HashiCorp Nomad và các nền tảng khác. Nhưng Kubernetes đang phát triển ngày càng mạnh mẽ, vì vậy tôi muốn đề cập đến Kubernetes nhưng muốn nói rằng nó không phải công nghệ duy nhất ngoài kia.
...
![](/static/images/assets/Day49_Kubernetes1.png)
...
![](/static/images/assets/Day49_Kubernetes2.png)
...
![](/static/images/assets/Day49_Kubernetes3.png)
...
![](/static/images/assets/Day49_Kubernetes4.png)
...
![](/static/images/assets/Day49_Kubernetes5.png)
...
![](/static/images/assets/Day49_Kubernetes6.png)
...
![](/static/images/assets/Day49_Kubernetes7.png)
...
![](/static/images/assets/Day49_Kubernetes8.png)
...
![](/static/images/assets/Day49_Kubernetes9.png)
...
![](/static/images/assets/Day49_Kubernetes10.png)
...
![](/static/images/assets/Day49_Kubernetes11.png)
...
![](/static/images/assets/Day49_Kubernetes12.png)
...
Hẹn gặp lại vào [ngày 50](https://vntechies.dev/courses/90-ngay-devops/ngay-50-chon-nen-tang-chay-kubernetes).
