---
title: 'Ngày 35 - Bức tranh toàn cảnh: Git - Quản lý phiên bản'
images: ['/static/images/ogps/90daysofdevopsd35.png']
summary: 'Trong bài mở đầu về git này, chúng ta sẽ đi qua khái niệm quản lý phiên bản và kiếm thức cơ bản về git.'
...
![](/static/images/assets/Day35_Git1.png)
...
![](/static/images/assets/Day35_Git2.png)
...
![](/static/images/assets/Day35_Git3.png)
...
![](/static/images/assets/Day35_Git4.png)
...
![](/static/images/assets/Day35_Git5.png)
...
![](/static/images/assets/Day35_Git6.png)

Bây giờ chúng ta có thể tạo một số tệp và thư mục cho mã nguồn hoặc cũng có thể đã có sẵn từ trước đó. Sử dụng lệnh `git add .` sẽ đặt tất cả cả tệp và thư mục trong thư mục của chúng ta vào một chiếc hộp nhưng chúng ta chưa commit bất cứ thứ gì vào cơ sở dữ liệu đó. Thao tác này có nghĩa là tất cả các tệp thuộc thư mục thực thi lệnh `git add` đã sẵn sàng để được thêm vào.

![](/static/images/assets/Day35_Git7.png)
...
![](/static/images/assets/Day35_Git10.png)
...
![](/static/images/assets/Day35_Git17.png)
...
![](/static/images/assets/Day35_Git18.png)
...
Hẹn gặp lại vào [ngày 36](https://vntechies.dev/courses/90-ngay-devops/ngay-36-cai-dat-cau-hinh-git)
