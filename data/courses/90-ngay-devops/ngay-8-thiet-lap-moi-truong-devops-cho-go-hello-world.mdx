---
title: 'Ngày 8 - Thiết lập môi trường DevOps cho Go & Hello World'
images: ['/static/images/ogps/90daysofdevopsd8.png']
summary: 'Cài đặt Go trên máy của bạn và thực hành với chương trình đầu tiên - Hello world'
...
![](/static/images/assets/Day8_Go1.png)
...
![](/static/images/assets/Day8_Go2.png)
...
![](/static/images/assets/Day8_Go3.png)
...
![](/static/images/assets/Day8_Go4.png)
...
![](/static/images/assets/Day8_Go5.png)
...
![](/static/images/assets/Day8_Go6.png)

Sau khi chúng ta cài đặt Go và có các thư mục sẵn sàng cho Go hoạt động, chúng ta cần một môi trường phát triển tích hợp (IDE). Có rất nhiều lựa chọn mà bạn có thể sử dụng nhưng phổ biến nhất và code editor mà tôi sử dụng là Visual Studio Code hoặc Code thay cho IDE. Bạn có thể tìm hiểu thêm về các IDEs tại [đây](https://www.youtube.com/watch?v=vUn5akOlFXQ).
...
![](/static/images/assets/Day8_Go7.png)
...
![](/static/images/assets/Day8_Go8.png)
...
![](/static/images/assets/Day08_Go14.png)
...
![](/static/images/assets/Day8_Go9.png)
...
![](/static/images/assets/Day8_Go10.png)
...
![](/static/images/assets/Day8_Go11.png)
...
![](/static/images/assets/Day8_Go12.png)
...
Hẹn gặp lại vào [ngày 9](https://vntechies.dev/courses/90-ngay-devops/ngay-9-giai-thich-ma-hello-world).

![](/static/images/assets/Day8_Go13.png)
