---
title: 'Ngày 65 - Ansible Playbooks'
images: ['/static/images/ogps/90daysofdevopsd65.png']
summary: 'Bài viết trình bày về ansible playbooks, task và plays với demo cơ bản'
...
Chúng ta có thể tìm thấy file ở trên tại [simple_play](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/Days/Configmgmt/simple_play.yml). Nếu sau đó chúng ta sử dụng lệnh `ansible-playbook simple_play.yml`, chúng ta sẽ đi qua các bước sau.

![](/static/images/assets/Day65_config1.png)
...
Bạn có thể tìm thấy tệp này ở đây ([Vagrantfile](https://github.com/vntechies/90DaysOfDevOps/tree/main/2022/Days/Configmgmt/Vagrantfile))
...
![](/static/images/assets/Day65_config2.png)
...
![](/static/images/assets/Day65_config3.png)
...
![](/static/images/assets/Day65_config5.png)

`ssh-copy-id localhost`

![](/static/images/assets/Day65_config6.png)
...
![](/static/images/assets/Day65_config7.png)
...
![](/static/images/assets/Day65_config4.png)
...
![](/static/images/assets/Day65_config8.png)
...
![](/static/images/assets/Day65_config9.png)
...
![](/static/images/assets/Day65_config10.png)
...
![](/static/images/assets/Day65_config11.png)
...
Hẹn gặp lại vào [ngày 66](https://vntechies.dev/courses/90-ngay-devops/ngay-66-tiep-tuc-voi-ansible-playbook).
