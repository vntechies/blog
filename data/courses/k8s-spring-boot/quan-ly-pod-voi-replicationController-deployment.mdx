...
### 3.3 Các chiến lược update trong Deployment(Deployment strategies)

### 3.4. Tạo và triển khai ứng dụng với Deployment
...
- Thực hiện rollback lại version trước đó của ứng dụng.
