...
| `spec.replicas` | Mô tả số lượng pod sẽ được ReplicationController tạo và quản lý. Vơí cả hai file trên đều là 3, lúc này ReplicationController sẽ đảm bảo số lượng pod luôn là 3 trên một thời điểm.                                                                                                                                            |
