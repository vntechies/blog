...
1. [Students Service] - _API tạo mới Student_: `/api/students` với method `POST` và Request body:
...
2. [Students Service] - _API lấy danh sách Student_: `/api/students` với method `GET`.
...
3. [Courses Service] - _API tạo mới Course_: `/api/courses/v1/createCourse` với method `POST` và Request body:
...
4. [Courses Service] - _API Học sinh tham gia Khóa Học_: `/api/courses/v1/joinCourse` với method `POST` và Request body:
...
5. [Courses Service] - _API Lấy chi tiết Khóa Học_: `/api/courses/v1/joinCourse` với method `GET`:
