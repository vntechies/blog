...
summary: 'Nhìn lại phiên bản đầu tiên của dự án #90DaysOfDevOps và nhấn mạnh tầm quan trọng của việc học hỏi liên tục và bảo mật trong DevOps.'
tags: ['devsecops', 'devops', '90daysofdevops']
date: '2024-11-05'
index: 1
chapter: 'Tuần 1'
---
...
Như đã nói ở trên, chúng ta hãy bắt đầu với [ngày 2](https://vntechies.dev/courses/90-ngay-devops-v2/ngay-2-buc-tranh-toan-canh-devsecops).
