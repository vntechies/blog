---
title: 'Ngày 5 - Bảo Mật Mã Nguồn Mở'
images: ['/static/images/ogps/90daysofdevopsv2d5.png']
summary: 'Tìm hiểu về bảo mật mã nguồn mở và cách bảo vệ hệ thống của bạn khi sử dụng phần mềm mã nguồn mở.'
...
Hẹn gặp lại vào [ngày 6](https://vntechies.dev/courses/90-ngay-devops-v2/ngay-6-thuc-hanh-xay-dung-mot-ung-dung-co-lo-hong).
