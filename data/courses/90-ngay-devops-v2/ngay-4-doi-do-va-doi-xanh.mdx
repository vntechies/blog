---
title: 'Ngày 4 - Đội Đỏ và Đội Xanh'
images: ['/static/images/ogps/90daysofdevopsv2d4.png']
summary: 'Tìm hiểu về vai trò của Đội Đỏ và Đội Xanh trong việc cải thiện tư thế bảo mật của tổ chức.'
...
![](/static/images/assets/day04-2.jpg)

**_[hình ảnh từ nguồn này](https://hackernoon.com/introducing-the-infosec-colour-wheel-blending-developers-with-red-and-blue-security-teams-6437c1a07700)_**
...
![](/static/images/assets/day04-1.png)
...
Hẹn gặp lại vào [ngày 5](https://vntechies.dev/courses/90-ngay-devops-v2/ngay-5-bao-mat-ma-nguon-mo).
