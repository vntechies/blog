...
Tiếp theo, chúng ta sẽ bắt đầu chủ đề **Xây dựng liên tục, Tích hợp liên tục, Kiểm thử liên tục** với [ngày 14](https://vntechies.dev/courses/90-ngay-devops-v2/ngay-14-quet-container-image), tập trung vào quét lỗ hổng container image dựa trên bài viết của [Anton Sankov](https://twitter.com/a_sankov).
