---
title: 'Ngày 6 - Thực Hành Xây Dựng Một Ứng Dụng Có Lỗ Hổng'
images: ['/static/images/ogps/90daysofdevopsv2d6.png']
summary: 'Thực hành xây dựng một ứng dụng yếu để hiểu rõ hơn về các lỗ hổng bảo mật và cách phòng tránh.'
...
_"[OWASP](https://owasp.org/) là một tổ chức phi lợi nhuận hoạt động để cải thiện bảo mật phần mềm. Thông qua các dự án phần mềm mã nguồn mở do cộng đồng dẫn dắt, hàng trăm chương trình trên toàn thế giới, hàng chục nghìn thành viên và các hội nghị giáo dục và đào tạo hàng đầu, Quỹ OWASP là nguồn lực cho các nhà phát triển và công nghệ để bảo mật web."_
...
![](/static/images/assets/day06-1.png)
...
![](/static/images/assets/day06-2.png)
...
![](/static/images/assets/day06-3.png)
...
![](/static/images/assets/day06-4.png)

Thêm một route mặc định vào config/routes.rb

`root bootcamps#index`

![](/static/images/assets/day06-5.png)
...
Hẹn gặp lại bạn vào [ngày 7](https://vntechies.dev/courses/90-ngay-devops-v2/ngay-7-tong-quan-ve-lap-trinh-an-toan), nơi chúng ta sẽ bắt đầu một phần mới về Lập trình an toàn.
