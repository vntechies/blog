---
title: 'Ngày 2 - Bức Tranh Toàn Cảnh: DevSecOps'
images: ['/static/images/ogps/90daysofdevopsv2d2.png']
summary: 'BCung cấp tổng quan về DevSecOps, sự khác biệt giữa DevSecOps và DevOps, và tầm quan trọng của bảo mật trong quy trình phát triển phần mềm.'
...
Hy vọng bài viết này đã mang lại cho bạn một cái nhìn tổng quan về những gì bạn có thể mong đợi từ module này và một số tài nguyên trên sẽ giúp cung cấp thêm kiến thức có chiều sâu cho chủ đề này. Trong bài đăng vào [ngày 3](https://vntechies.dev/courses/90-ngay-devops-v2/ngay-3-tu-duy-nhu-mot-ke-tan-cong), chúng ta sẽ xem xét cách suy nghĩ của kẻ tấn công, đó cũng là lý do tại sao chúng ta phải bảo vệ ngay từ đầu.
