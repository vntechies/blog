---
title: Tác vụ Fargate được lập lịch - Scheduled Fargate Tasks với AWS CDK
date: '2022-11-11'
tags: ['aws', 'aws cdk', 'devops', 'fargate', 'ecs']
draft: false
images: ['/static/images/ogps/aws_scheduled_fargate_task.png']
summary: 'Bài viết này sẽ giải thích những gì cần thiết để triển khai một tác vụ Fargate được lập lịch (Scheduled Fargate Tasks) bằng AWS CDK'
index: 7
---
...
Để sử dụng các tác vụ Fargate được lập lịch, trước tiên, bạn cần thiết lập một Virtual Private cloud (VPC). VPC là một mạng ảo được tách biệt cho phép bạn khởi chạy các tài nguyên AWS của mình, ví dụ như các tác vụ Fargate được lập lịch.
...
```yaml:aws_cdk_scheduled_fargate_task_stack.py
...
![Tác vụ Fargate đã được tạo](/static/images/assets/aws_cdk_fargate_ecs.png)

![Log được tạo bởi tác vụ Fargate được lên lịch](/static/images/assets/aws_cdk_fargate_cloudwatch.png)
