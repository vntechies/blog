...
Nếu bạn muốn tìm hiểu sâu hơn, hãy tham khảo các [ví dụ của AWS CDK](https://github.com/aws-samples/aws-cdk-examples) và bắt đầu xây dựng các ứng dụng thực tế sử dụng AWS CDK qua các bài viết dưới đây của VNTechies 😉
...
<div className="container py-12">
  <div className="-m-4 flex flex-wrap">
    ...
    <Card
      ...
      description="Hướng dẫn này sẽ giải thích những gì cần thiết để tạo một Amazon S3 bucket sử dụng AWS CDK Python"
      imgSrc="/static/images/ogps/s3-cdk.png"
      href="/blog/aws/cdk/tao-s3-bucket-voi-aws-cdk"
    />
  </div>
</div>
