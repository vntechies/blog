...
Nếu chúng ta chỉ sử dụng L1 Construct, thực sự thì không có lợi ích nào so với việc sử dụng CloudFormation. Tuy nghiên, nếu L2 hoặc L3 Construct không cho phép bạn tùy chỉnh một thuộc tính nhất định thì bạn có thể khắc phục bằng cách sử dụng L1 Construct.
