---
title: Tạo dịch vụ Fargate với bộ cân bằng tải ứng dụng bằng AWS CDK
date: '2022-11-11'
tags: ['aws', 'aws cdk', 'devops', 'fargate', 'ecs', 'alb']
draft: false
images: ['/static/images/ogps/aws_alb_fargate.png']
summary: 'Bài viết này sẽ giải thích các bước thiết để triển khai một dịch vụ Fargate với bộ bằng tải ứng dụng bằng AWS CDK'
index: 7
---
...
![Dịch vụ Fargate đã được tạo](/static/images/assets/awscdk_fargate_alb_cli.png)

![Khi truy cập vào địa chỉ được cung cấp](/static/images/assets/awscdk_fargate_alb_web.png)
