...
Bạn cũng có thể tham khảo bài viết [hướng dẫn chi tiết cài đặt AWS CDK](/courses/aws/cdk/huong-dan-chi-tiet-cai-dat-aws-cdk)
...
```python:aws_cdk_python_s3_stack.py {16, 17, 18, 20}
