      ...
      <div className="mx-auto grid max-w-screen-xl px-4 py-8 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <div className="flex flex-col items-start space-y-3 sm:flex-row sm:items-center sm:space-x-4 sm:space-y-0">
            <Link
              href="/blog"
              className="mr-3 inline-flex items-center justify-center rounded-lg bg-primary-400 px-5 py-3 text-center text-base font-medium focus:ring-4 focus:ring-primary-300 hover:bg-primary-800 dark:bg-primary-700 dark:focus:ring-primary-900"
            >
              Đọc bài ngay!
              <svg
