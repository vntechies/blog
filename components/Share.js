    ...
    <div className="text-md pt-6 pb-6 text-gray-700 dark:text-gray-300">
      <div className="flex space-x-2 md:space-x-4">
        ...
        <Link
          ...
          type="button"
          href={`https://www.facebook.com/dialog/feed?app_id=${siteMetadata.comment.facebookConfig.appId}&display=popup&link=https%3A//vntechies.dev${href}`}
